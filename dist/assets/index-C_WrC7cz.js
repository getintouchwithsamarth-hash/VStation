 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var id;function pm(){if(id)return bo;id=1;var i=xl(),a=Symbol.for("react.element"),l=Symbol.for("react.fragment"),c=Object.prototype.hasOwnProperty,p=i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,f={key:!0,ref:!0,__self:!0,__source:!0};function m(x,S,j){var C,h={},w=null,T=null;j!==void 0&&(w=""+j),S.key!==void 0&&(w=""+S.key),S.ref!==void 0&&(T=S.ref);for(C in S)c.call(S,C)&&!f.hasOwnProperty(C)&&(h[C]=S[C]);if(x&&x.defaultProps)for(C in S=x.defaultProps,S)h[C]===void 0&&(h[C]=S[C]);return{$$typeof:a,type:x,key:w,ref:T,props:h,_owner:p.current}}return bo.Fragment=l,bo.jsx=m,bo.jsxs=m,bo}var sd;function fm(){return sd||(sd=1,Ja.exports=pm()),Ja.exports}var r=fm(),_=xl();const O=Rd(_);var ns={},el={exports:{}},vt={},tl={exports:{}},nl={};/**
 * @license React
...
`,$d=`@inContext(country: ${ul}, language: ${Dd})`,Dm=`
  query ProductList(
    $first: Int = 24
    $after: String
...
`,hs=(i,a)=>{const l=i[a];if(l.userErrors.length>0){const c=l.userErrors[0];throw new Re(c.message,"CART_USER_ERROR",c.field)}if(!l.cart)throw new Re("Cart was not returned by Shopify","MISSING_CART");return l.cart};async function Vm(i){return(await Ve(Mm,{handle:i})).product}async function Oo(i={}){const a=typeof i=="number"?{first:i}:i;return(await Ve(Dm,{first:a.first??24,after:a.after??null,sortKey:a.sortKey??"BEST_SELLING",reverse:a.reverse??!1,query:a.query})).products}async function qm(i=[]){const a=await Ve(Om,{input:{lines:i,buyerIdentity:{countryCode:ul}},country:ul,language:Dd});return hs(a,"cartCreate")}async function Qm(i,a){const l=await Ve(Bm,{cartId:i,lines:a});return hs(l,"cartLinesAdd")}async function Ym(i,a){const l=await Ve($m,{cartId:i,lines:a});return hs(l,"cartLinesUpdate")}async function Km(i,a){const l=await Ve(Um,{cartId:i,lineIds:a});return hs(l,"cartLinesRemove")}async function Xm(i){return(await Ve(Hm,{id:i})).cart}async function Gm(i,a){const c=(await Ve(Wm,{cartId:i,buyerIdentity:a})).cartBuyerIdentityUpdate;if(c.userErrors.length>0){const p=c.userErrors[0];throw new Re(p.message,"CART_USER_ERROR",p.field)}if(!c.cart)throw new Re("Cart was not returned by Shopify","MISSING_CART");return c.cart}const Jm=()=>typeof window>"u"?null:window.localStorage.getItem(Md),Zm=i=>{typeof window>"u"||window.localStorage.setItem(Md,i)},yl="customer_token",vl="token_expires_at",Ud=`
  id
  email
  firstName
  lastName
...
`,gs=()=>typeof window<"u",Hd=i=>{if(!i)return!0;const a=Date.parse(i);return Number.isNaN(a)?!0:a<=Date.now()},wl=i=>{gs()&&(window.localStorage.setItem(yl,i.accessToken),window.localStorage.setItem(vl,i.expiresAt))},Wd=()=>gs()?window.localStorage.getItem(yl):null,Vd=()=>gs()?window.localStorage.getItem(vl):null,th=i=>{var l;const a=(l=i.field)!=null&&l.length?` for ${i.field.join(".")}`:"";switch(i.code){case"TAKEN":return`A customer already exists${a}.`;case"INVALID":return`Shopify rejected the value${a}. ${i.message}`;case"UNIDENTIFIED_CUSTOMER":return"The email or password is incorrect.";case"CUSTOMER_DISABLED":return"This customer account is disabled.";case"BAD_DOMAIN":return`The email address domain is invalid${a}.`;case"TOKEN_INVALID":return"The customer session is invalid. Please sign in again.";case"CUSTOMER_RESET_TOKEN_INVALID":case"TOKEN_EXPIRED":return"This link has expired. Please request a new one.";default:return i.message}},nh=(i,a,l)=>i instanceof Re?{type:i.code==="HTTP_ERROR"||i.code==="RATE_LIMIT"?"network":"api",message:i.message||l,code:i.code||a,field:i.field}:i instanceof TypeError?{type:"network",message:"Network request failed while contacting Shopify.",code:a}:{type:"unknown",message:l,code:a},cl=i=>({ok:!1,data:null,error:i}),kl=i=>({ok:!0,data:i,error:null}),gn=(i,a)=>{if(i.length===0)return;const l=i[0];throw new Re(th(l),l.code||a,l.field)},rh=()=>{const i=Wd(),a=Vd();return!i||!a?(dl(),cl({type:"session",message:"No active customer session was found.",code:"CUSTOMER_SESSION_MISSING"})):Hd(a)?(dl(),cl({type:"session",message:"The customer session has expired. Please sign in again.",code:"CUSTOMER_SESSION_EXPIRED"})):kl(i)},Mt=async(i,a,l)=>{try{return kl(await i())}catch(c){return cl(nh(c,a,l))}};function dl(){gs()&&(window.localStorage.removeItem(yl),window.localStorage.removeItem(vl))}function zo(){const i=Wd(),a=Vd();return{accessToken:i,expiresAt:a,isExpired:Hd(a)}}function rs(){dl()}const oh=`
...
`;async function gh(i){return Mt(async()=>{const a=await Ve(oh,{input:i});if(gn(a.customerCreate.customerUserErrors,"CUSTOMER_CREATE_ERROR"),!a.customerCreate.customer)throw new Re("Customer was not returned by Shopify","MISSING_CUSTOMER");return a.customerCreate.customer},"CUSTOMER_CREATE_ERROR","Unable to create the customer account.")}async function pd(i,a){return Mt(async()=>{const l=await Ve(ih,{input:{email:i,password:a}});if(gn(l.customerAccessTokenCreate.customerUserErrors,"CUSTOMER_LOGIN_ERROR"),!l.customerAccessTokenCreate.customerAccessToken)throw new Re("Customer access token was not returned by Shopify","MISSING_CUSTOMER_TOKEN");return wl(l.customerAccessTokenCreate.customerAccessToken),l.customerAccessTokenCreate.customerAccessToken},"CUSTOMER_LOGIN_ERROR","Unable to sign in the customer.")}async function fd(i){const a=i?kl(i):rh();return a.ok?Mt(async()=>{const l=await Ve(sh,{customerAccessToken:a.data});if(l.customerAccessTokenRenew.userErrors.length>0){const c=l.customerAccessTokenRenew.userErrors[0];throw new Re(c.message,"CUSTOMER_TOKEN_RENEW_ERROR",c.field)}if(!l.customerAccessTokenRenew.customerAccessToken)throw new Re("Customer access token renewal did not return a token","MISSING_CUSTOMER_TOKEN");return wl(l.customerAccessTokenRenew.customerAccessToken),l.customerAccessTokenRenew.customerAccessToken},"CUSTOMER_TOKEN_RENEW_ERROR","Unable to renew the customer session."):a}async function xh(i){return Mt(async()=>{const a=await Ve(ah,{email:i});return gn(a.customerRecover.customerUserErrors,"CUSTOMER_RECOVER_ERROR"),{email:i,submitted:!0}},"CUSTOMER_RECOVER_ERROR","Unable to request a password reset.")}async function yh(i,a){return Mt(async()=>{const l=await Ve(lh,{resetUrl:i,password:a});if(gn(l.customerResetByUrl.customerUserErrors,"CUSTOMER_RESET_ERROR"),!l.customerResetByUrl.customerAccessToken)throw new Re("Customer password reset did not return a new access token","MISSING_CUSTOMER_TOKEN");return wl(l.customerResetByUrl.customerAccessToken),l.customerResetByUrl.customerAccessToken},"CUSTOMER_RESET_ERROR","Unable to reset the customer password.")}async function Ro(i){return Mt(async()=>(await Ve(uh,{customerAccessToken:i})).customer,"CUSTOMER_FETCH_ERROR","Unable to load customer data.")}async function vh(i,a=10,l){return Mt(async()=>{var p;return((p=(await Ve(ch,{customerAccessToken:i,first:a,after:l||null})).customer)==null?void 0:p.orders)||null},"CUSTOMER_ORDERS_FETCH_ERROR","Unable to load customer orders.")}async function wh(i,a){return Mt(async()=>{const l=await Ve(dh,{customerAccessToken:i,customer:a});if(gn(l.customerUpdate.customerUserErrors,"CUSTOMER_UPDATE_ERROR"),!l.customerUpdate.customer)throw new Re("Customer was not returned by Shopify","MISSING_CUSTOMER");return l.customerUpdate.customer},"CUSTOMER_UPDATE_ERROR","Unable to update the customer profile.")}async function kh(i,a){return Mt(async()=>{const l=await Ve(ph,{customerAccessToken:i,address:a});if(gn(l.customerAddressCreate.customerUserErrors,"CUSTOMER_ADDRESS_CREATE_ERROR"),!l.customerAddressCreate.customerAddress)throw new Re("Customer address was not returned by Shopify","MISSING_CUSTOMER_ADDRESS");return l.customerAddressCreate.customerAddress},"CUSTOMER_ADDRESS_CREATE_ERROR","Unable to create the customer address.")}async function Sh(i,a,l){return Mt(async()=>{const c=await Ve(fh,{customerAccessToken:i,id:a,address:l});if(gn(c.customerAddressUpdate.customerUserErrors,"CUSTOMER_ADDRESS_UPDATE_ERROR"),!c.customerAddressUpdate.customerAddress)throw new Re("Customer address was not returned by Shopify","MISSING_CUSTOMER_ADDRESS");return c.customerAddressUpdate.customerAddress},"CUSTOMER_ADDRESS_UPDATE_ERROR","Unable to update the customer address.")}async function jh(i,a){return Mt(async()=>{const l=await Ve(mh,{customerAccessToken:i,id:a});if(gn(l.customerAddressDelete.customerUserErrors,"CUSTOMER_ADDRESS_DELETE_ERROR"),!l.customerAddressDelete.deletedCustomerAddressId)throw new Re("Deleted customer address id was not returned by Shopify","MISSING_CUSTOMER_ADDRESS");return l.customerAddressDelete.deletedCustomerAddressId},"CUSTOMER_ADDRESS_DELETE_ERROR","Unable to delete the customer address.")}async function bh(i,a){return Mt(async()=>{const l=await Ve(hh,{customerAccessToken:i,addressId:a});if(gn(l.customerDefaultAddressUpdate.customerUserErrors,"CUSTOMER_DEFAULT_ADDRESS_UPDATE_ERROR"),!l.customerDefaultAddressUpdate.customer)throw new Re("Customer was not returned by Shopify","MISSING_CUSTOMER");return l.customerDefaultAddressUpdate.customer.defaultAddress},"CUSTOMER_DEFAULT_ADDRESS_UPDATE_ERROR","Unable to update the default address.")}const Ch=(i,a)=>{const l=Number(i);return!Number.isFinite(l)||!a?i||"":new Intl.NumberFormat("en-US",{style:"currency",currency:a}).format(l)},Co=(i,a)=>({id:i.id,email:i.email,firstName:i.firstName||"",lastName:i.lastName||"",phone:i.phone||void 0,acceptsMarketing:!1,createdAt:a||new Date().toISOString()}),Eh=i=>{var l;const a=((l=i.defaultAddress)==null?void 0:l.id)||null;return i.addresses.edges.map(c=>c.node).filter(c=>!!(c!=null&&c.id)).map(c=>({id:c.id,firstName:"",lastName:"",company:void 0,address1:c.address1||"",address2:c.address2||void 0,city:c.city||"",province:c.province||"",zip:c.zip||"",country:c.country||"",phone:void 0,isDefault:c.id===a}))},Ih=i=>i?i.edges.map(a=>{var l,c;return{id:a.node.id,orderNumber:String(a.node.orderNumber),createdAt:a.node.processedAt,totalPrice:Ch((l=a.node.totalPriceV2)==null?void 0:l.amount,(c=a.node.totalPriceV2)==null?void 0:c.currencyCode),fulfillmentStatus:a.node.fulfillmentStatus==="FULFILLED"||a.node.fulfillmentStatus==="UNFULFILLED"||a.node.fulfillmentStatus==="PARTIALLY_FULFILLED"||a.node.fulfillmentStatus==="CANCELLED"?a.node.fulfillmentStatus:"UNFULFILLED",lineItems:a.node.lineItems.edges.map((p,f)=>({id:`${a.node.id}-${f}`,title:p.node.title,quantity:p.node.quantity,price:""}))}}):[],md=i=>({firstName:i.firstName||void 0,lastName:i.lastName||void 0,company:i.company||void 0,address1:i.address1||void 0,address2:i.address2||void 0,city:i.city||void 0,province:i.province||void 0,zip:i.zip||void 0,country:i.country||void 0,phone:i.phone||void 0});function Th(){const[i,a]=_.useState(null),[l,c]=_.useState(null),[p,f]=_.useState(!0),m=async()=>{const T=zo();if(!T.accessToken){a(null),c(null);return}const R=await fd(T.accessToken);if(!R.ok)throw rs(),a(null),c(null),new Error(R.error.message||"Customer session expired.");const M=await Ro(R.data.accessToken);if(!M.ok||!M.data)throw new Error(M.error.message||"Unable to load customer data.");a(Co(M.data,i==null?void 0:i.createdAt)),c(R.data.accessToken)};return _.useEffect(()=>{let T=!1;return(async()=>{var M;try{const A=zo();if(!A.accessToken){T||(a(null),c(null),f(!1));return}const U=await fd(A.accessToken);if(!U.ok){T||(rs(),a(null),c(null));return}const K=await Ro(U.data.accessToken);if(!K.ok||!K.data)throw new Error(((M=K.error)==null?void 0:M.message)||"Unable to load customer data.");T||(a(Co(K.data)),c(U.data.accessToken))}catch{T||(rs(),a(null),c(null))}finally{T||f(!1)}})(),()=>{T=!0}},[]),{customer:i,accessToken:l,isAuthenticated:!!(i&&l),isLoading:p,login:async(T,R)=>{f(!0);try{const M=await pd(T,R);if(!M.ok)throw new Error(M.error.message||"Unable to sign in.");const A=await Ro(M.data.accessToken);if(!A.ok||!A.data)throw new Error(A.error.message||"Unable to load customer data.");a(Co(A.data)),c(M.data.accessToken)}finally{f(!1)}},register:async T=>{f(!0);try{const R=await gh(T);if(!R.ok)throw new Error(R.error.message||"Unable to create the account.");const M=await pd(T.email,T.password);if(!M.ok)throw new Error(M.error.message||"Account created but sign-in failed.");const A=await Ro(M.data.accessToken);if(!A.ok||!A.data)throw new Error(A.error.message||"Unable to load customer data.");a(Co(A.data,new Date().toISOString())),c(M.data.accessToken)}finally{f(!1)}},logout:()=>{rs(),a(null),c(null)},updateProfile:async T=>{const R=l||zo().accessToken;if(!R)throw new Error("No active customer session was found.");f(!0);try{const M=await wh(R,T);if(!M.ok)throw new Error(M.error.message||"Unable to update the profile.");a(A=>Co(M.data,A==null?void 0:A.createdAt))}finally{f(!1)}},refreshCustomerData:m,requestPasswordReset:async T=>{const R=await xh(T);if(!R.ok)throw new Error(R.error.message||"Unable to send the password reset email.")},resetPassword:async(T,R)=>{const M=await yh(T,R);if(!M.ok){const A=new Error(M.error.message||"Unable to reset the password.");throw A.code=M.error.code,A}}}}function Fh(){const{accessToken:i,isAuthenticated:a}=xn(),[l,c]=_.useState([]),[p,f]=_.useState(!0),[m,x]=_.useState(!1),[S,j]=_.useState(null),C=i||zo().accessToken,h=async()=>{var T;if(!C||!a){c([]),f(!1);return}f(!0),j(null);try{const R=await Ro(C);if(!R.ok||!R.data)throw new Error(((T=R.error)==null?void 0:T.message)||"Unable to load addresses.");c(Eh(R.data))}catch(R){j(R instanceof Error?R.message:"Unable to load addresses.")}finally{f(!1)}};_.useEffect(()=>{h()},[C,a]);const w=async T=>{x(!0),j(null);try{await T(),await h()}catch(R){const M=R instanceof Error?R.message:"Unable to update addresses.";throw j(M),R}finally{x(!1)}};return{addresses:l,isLoading:p,isSaving:m,error:S,refresh:h,createAddress:async T=>{if(!C)throw new Error("No active customer session was found.");await w(async()=>{const R=await kh(C,md(T));if(!R.ok)throw new Error(R.error.message||"Unable to create address.")})},editAddress:async T=>{if(!C)throw new Error("No active customer session was found.");await w(async()=>{const R=await Sh(C,T.id,md(T));if(!R.ok)throw new Error(R.error.message||"Unable to update address.")})},removeAddress:async T=>{if(!C)throw new Error("No active customer session was found.");await w(async()=>{const R=await jh(C,T);if(!R.ok)throw new Error(R.error.message||"Unable to delete address.")})},makeDefaultAddress:async T=>{if(!C)throw new Error("No active customer session was found.");await w(async()=>{const R=await bh(C,T);if(!R.ok)throw new Error(R.error.message||"Unable to set the default address.")})}}}function _h(){const{accessToken:i,isAuthenticated:a}=xn(),[l,c]=_.useState([]),[p,f]=_.useState(null),[m,x]=_.useState(!0),[S,j]=_.useState(!1),[C,h]=_.useState(null),w=i||zo().accessToken,T=async(R,M=!1)=>{if(!w||!a){c([]),f(null),x(!1);return}M?j(!0):x(!0),h(null);try{const A=await vh(w,10,R);if(!A.ok)throw new Error(A.error.message||"Unable to load orders.");const U=Ih(A.data);c(K=>M?[...K,...U]:U),f(A.data?{hasNextPage:A.data.pageInfo.hasNextPage,hasPreviousPage:A.data.pageInfo.hasPreviousPage,startCursor:A.data.pageInfo.startCursor,endCursor:A.data.pageInfo.endCursor}:null)}catch(A){h(A instanceof Error?A.message:"Unable to load orders.")}finally{x(!1),j(!1)}};return _.useEffect(()=>{T()},[w,a]),{orders:l,pageInfo:p,hasMore:!!(p!=null&&p.hasNextPage&&(p!=null&&p.endCursor)),isLoading:m,isLoadingMore:S,error:C,refresh:async()=>T(),loadMore:async()=>{p!=null&&p.endCursor&&await T(p.endCursor,!0)}}}const qd=_.createContext(null);function xn(){const i=_.useContext(qd);if(!i)throw new Error("useAuth must be used within an AuthProvider");return i}function Rh({children:i}){const a=Th(),l={customer:a.customer,accessToken:a.accessToken,isAuthenticated:a.isAuthenticated,isLoading:a.isLoading,login:async(c,p)=>{await a.login(c,p)},register:async c=>{await a.register(c)},logout:()=>{a.logout()},updateProfile:async c=>{await a.updateProfile(c)},refreshCustomerData:async()=>{await a.refreshCustomerData()},requestPasswordReset:async c=>{await a.requestPasswordReset(c)},resetPassword:async(c,p)=>{await a.resetPassword(c,p)}};return r.jsx(qd.Provider,{value:l,children:i})}/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Nh=i=>i.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),zh=i=>i.replace(/^([A-Z])|[\s-_]+(\w)/g,(a,l,c)=>c?c.toUpperCase():l.toLowerCase()),hd=i=>{const a=zh(i);return a.charAt(0).toUpperCase()+a.slice(1)},Qd=(...i)=>i.filter((a,l,c)=>!!a&&a.trim()!==""&&c.indexOf(a)===l).join(" ").trim();/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ph=_.forwardRef(({color:i="currentColor",size:a=24,strokeWidth:l=2,absoluteStrokeWidth:c,className:p="",children:f,iconNode:m,...x},S)=>_.createElement("svg",{ref:S,...Ah,width:a,height:a,stroke:i,strokeWidth:c?Number(l)*24/Number(a):l,className:Qd("lucide",p),...x},[...m.map(([j,C])=>_.createElement(j,C)),...Array.isArray(f)?f:[f]]));/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ye=(i,a)=>{const l=_.forwardRef(({className:c,...p},f)=>_.createElement(Ph,{ref:f,iconNode:a,className:Qd(`lucide-${Nh(hd(i))}`,`lucide-${i}`,c),...p}));return l.displayName=hd(i),l};/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Lh=[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]],Yd=ye("arrow-left",Lh);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Dh=[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]],Kd=ye("check",Dh);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const qh=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]],Qh=ye("circle-check",qh);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Yh=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m15 9-6 6",key:"1uzhvr"}],["path",{d:"m9 9 6 6",key:"z0biqf"}]],Kh=ye("circle-x",Yh);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ng=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 16v-4",key:"1dtifu"}],["path",{d:"M12 8h.01",key:"e9boi3"}]],Xd=ye("info",ng);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const rg=[["path",{d:"M21 12a9 9 0 1 1-6.219-8.56",key:"13zald"}]],og=ye("loader-circle",rg);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ig=[["path",{d:"M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4",key:"1uf3rs"}],["polyline",{points:"16 17 21 12 16 7",key:"1gabdz"}],["line",{x1:"21",x2:"9",y1:"12",y2:"12",key:"1uyos4"}]],sg=ye("log-out",ig);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ug=[["path",{d:"M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0",key:"1r0f0z"}],["circle",{cx:"12",cy:"10",r:"3",key:"ilqhr7"}]],Sl=ye("map-pin",ug);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const pg=[["path",{d:"M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z",key:"a7tn18"}]],Gd=ye("moon",pg);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const fg=[["path",{d:"M11 21.73a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73z",key:"1a0edw"}],["path",{d:"M12 22V12",key:"d0xqtd"}],["polyline",{points:"3.29 7 12 12 20.71 7",key:"ousv84"}],["path",{d:"m7.5 4.27 9 5.15",key:"1c824w"}]],Uo=ye("package",fg);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const kg=[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z",key:"oel41y"}]],Sg=ye("shield",kg);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const jg=[["circle",{cx:"12",cy:"12",r:"4",key:"4exip2"}],["path",{d:"M12 2v2",key:"tus03m"}],["path",{d:"M12 20v2",key:"1lh1kg"}],["path",{d:"m4.93 4.93 1.41 1.41",key:"149t6j"}],["path",{d:"m17.66 17.66 1.41 1.41",key:"ptbguv"}],["path",{d:"M2 12h2",key:"1t8f8n"}],["path",{d:"M20 12h2",key:"1q8mjw"}],["path",{d:"m6.34 17.66-1.41 1.41",key:"1m8zz5"}],["path",{d:"m19.07 4.93-1.41 1.41",key:"1shlcs"}]],Jd=ye("sun",jg);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const bg=[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3",key:"wmoenq"}],["path",{d:"M12 9v4",key:"juzpu7"}],["path",{d:"M12 17h.01",key:"p32p05"}]],Cg=ye("triangle-alert",bg);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Eg=[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]],Zd=ye("user",Eg);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ig=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],jl=ye("x",Ig);/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Tg=[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z",key:"1xq2db"}]],Fg=ye("zap",Tg);function Ie({label:i,error:a,helperText:l,showPasswordToggle:c,type:p="text",disabled:f,...m}){const[x,S]=_.useState(!1),[j,C]=_.useState(!1),h=c&&x?"text":p;return r.jsxs("div",{style:{width:"100%"},children:[r.jsx("label",{htmlFor:m.id,style:{display:"block",fontSize:"14px",lineHeight:"20px",fontWeight:"500",color:"#344054",marginBottom:"6px",fontFamily:"Inter, system-ui, sans-serif"},children:i}),r.jsxs("div",{style:{position:"relative"},children:[r.jsx("input",{...m,type:h,disabled:f,onFocus:w=>{var T;C(!0),(T=m.onFocus)==null||T.call(m,w)},onBlur:w=>{var T;C(!1),(T=m.onBlur)==null||T.call(m,w)},style:{width:"100%",height:"44px",padding:"10px 14px",paddingRight:c?"44px":"14px",fontSize:"16px",lineHeight:"24px",fontWeight:"400",fontFamily:"Inter, system-ui, sans-serif",color:f?"#98A2B3":"#101828",backgroundColor:f?"#F9FAFB":"#FFFFFF",border:`1px solid ${a?"#F04438":j?"#4F46E5":"#D0D5DD"}`,borderRadius:"10px",outline:"none",boxShadow:j&&!a?"0 0 0 2px rgba(79, 70, 229, 0.06)":"none",cursor:f?"not-allowed":"text",transition:"all 0.15s ease"}}),c&&r.jsx("button",{type:"button",onClick:()=>S(!x),disabled:f,style:{position:"absolute",right:"12px",top:"50%",transform:"translateY(-50%)",background:"none",border:"none",padding:"4px",cursor:f?"not-allowed":"pointer",color:"#667085",display:"flex",alignItems:"center",justifyContent:"center",opacity:f?.4:1},"aria-label":x?"Hide password":"Show password",children:x?r.jsx(Zh,{size:20}):r.jsx(tg,{size:20})})]}),a&&r.jsx("div",{style:{marginTop:"6px",fontSize:"14px",lineHeight:"20px",fontWeight:"400",color:"#F04438",fontFamily:"Inter, system-ui, sans-serif"},children:a}),!a&&l&&r.jsx("div",{style:{marginTop:"6px",fontSize:"14px",lineHeight:"20px",fontWeight:"400",color:"#667085",fontFamily:"Inter, system-ui, sans-serif"},children:l})]})}function dt({variant:i="primary",size:a="md",isLoading:l=!1,disabled:c,children:p,...f}){const m=c||l,x={sm:{height:"36px",padding:"0 12px",borderRadius:"10px",gap:"8px",fontSize:"14px",lineHeight:"20px"},md:{height:"44px",padding:"0 16px",borderRadius:"12px",gap:"10px",fontSize:"14px",lineHeight:"20px"},lg:{height:"52px",padding:"0 20px",borderRadius:"14px",gap:"12px",fontSize:"18px",lineHeight:"28px"}},S={primary:{backgroundColor:"#4338CA",color:"#FFFFFF",border:"none"},secondary:{backgroundColor:"#FFFFFF",color:"#101828",border:"1px solid #D0D5DD"},ghost:{backgroundColor:"transparent",color:"#101828",border:"none"},destructive:{backgroundColor:"#F04438",color:"#FFFFFF",border:"none"}},j=x[a],C=S[i];return r.jsxs("button",{...f,disabled:m,style:{display:"inline-flex",alignItems:"center",justifyContent:"center",fontFamily:"Inter, system-ui, sans-serif",fontWeight:"600",cursor:m?"not-allowed":"pointer",opacity:m?.4:1,transition:"all 0.15s ease",position:"relative",whiteSpace:"nowrap",...j,...C,...f.style},onMouseEnter:h=>{!m&&i!=="ghost"&&(h.currentTarget.style.filter="brightness(0.94)")},onMouseLeave:h=>{h.currentTarget.style.filter="none"},onMouseDown:h=>{m||(h.currentTarget.style.filter="brightness(0.88)")},onMouseUp:h=>{m||(h.currentTarget.style.filter="brightness(0.94)")},children:[l&&r.jsx(og,{size:a==="sm"?14:a==="lg"?18:16,style:{animation:"spin 1s linear infinite"}}),p,r.jsx("style",{children:`
          @keyframes spin {
            from {
      ...
      `}),r.jsxs("header",{className:"header-container",children:[r.jsx(he,{children:r.jsxs("div",{className:"header-inner",children:[r.jsx(ix,{isDark:p}),r.jsx(sx,{}),r.jsx(ax,{accountHref:S,accountLabel:x,isDark:p,onToggleTheme:()=>c(p?"light":"dark")}),r.jsx("button",{className:"header-mobile-menu-btn",onClick:()=>m(!f),"aria-label":"Toggle mobile menu",children:f?r.jsx(jl,{size:20}):r.jsx(dg,{size:20})})]})}),r.jsxs("div",{className:`header-mobile-menu${f?" open":""}`,children:[r.jsxs("nav",{className:"header-mobile-nav",children:[r.jsx("a",{href:"/products",className:"header-mobile-nav-link",onClick:()=>m(!1),children:"Products"}),r.jsx("a",{href:"/philosophy",className:"header-mobile-nav-link",onClick:()=>m(!1),children:"Philosophy"}),r.jsx("a",{href:"/community",className:"header-mobile-nav-link",onClick:()=>m(!1),children:"Community"})]}),r.jsxs("div",{className:"header-mobile-actions",children:[r.jsx("a",{href:S,className:"header-mobile-account-btn",onClick:()=>m(!1),style:{textDecoration:"none"},children:x}),r.jsxs("button",{className:"header-mobile-account-btn",onClick:()=>c(p?"light":"dark"),children:[p?r.jsx(Jd,{size:20,style:{marginRight:"8px"}}):r.jsx(Gd,{size:20,style:{marginRight:"8px"}}),p?"Light Mode":"Dark Mode"]})]})]})]})]})}function ix({isDark:i}){return r.jsx(lx,{isDark:i})}function sx(){return r.jsx(cx,{})}function ax({accountHref:i,accountLabel:a,isDark:l,onToggleTheme:c}){return r.jsxs("div",{className:"header-right",children:[r.jsx(ux,{isDark:l,onToggleTheme:c}),r.jsx(dx,{href:i,label:a}),r.jsx(px,{})]})}function lx({isDark:i}){return r.jsx(zd,{size:32,variant:i?"light":"dark",showText:!0,href:"/"})}function ux({isDark:i,onToggleTheme:a}){return r.jsxs("button",{"aria-label":`Switch to ${i?"light":"dark"} mode`,onClick:a,style:{height:"36px",paddingLeft:"12px",paddingRight:"12px",borderRadius:"10px",backgroundColor:"transparent",color:"var(--foreground)",fontSize:"14px",lineHeight:"20px",fontWeight:"600",border:"1px solid var(--border)",display:"inline-flex",alignItems:"center",gap:"8px",cursor:"pointer"},children:[i?r.jsx(Jd,{size:16}):r.jsx(Gd,{size:16}),r.jsx("span",{className:"theme-toggle-text",children:i?"Light":"Dark"})]})}function cx(){return r.jsxs("nav",{className:"header-nav",children:[r.jsx("a",{href:"/products",className:"header-nav-link",children:"Products"}),r.jsx("a",{href:"/philosophy",className:"header-nav-link",children:"Philosophy"}),r.jsx("a",{href:"/community",className:"header-nav-link",children:"Community"})]})}function dx({href:i,label:a}){return r.jsx("a",{href:i,className:"header-account-btn",style:{height:"36px",paddingLeft:"12px",paddingRight:"12px",borderRadius:"10px",backgroundColor:"transparent",color:"var(--foreground)",fontSize:"14px",lineHeight:"20px",fontWeight:"600",border:"none",display:"inline-flex",alignItems:"center",cursor:"pointer",textDecoration:"none"},children:a})}function px(){const{cartCount:i,openCartDrawer:a}=Vn(),l=()=>{(window.location.pathname.replace(/\/+$/,"")||"/")!=="/cart"&&a()};return r.jsxs("div",{style:{position:"relative",display:"inline-flex"},children:[r.jsx(We,{label:"Cart",variant:"ghost",size:"sm",onClick:l}),r.jsx("div",{style:{position:"absolute",top:"-6px",right:"-8px",pointerEvents:"none",opacity:.78},children:r.jsx(it,{label:String(i),variant:"accent",size:"sm"})})]})}function Se({children:i,direction:a="vertical",gap:l=16,align:c="stretch",justify:p="flex-start",style:f,responsiveDirection:m,responsiveGap:x}){const S=a==="horizontal"?"row":"column",j=typeof l=="number"?`${l}px`:l,C=m||x,h=C?`stack-${Math.random().toString(36).substr(2,9)}`:"";return r.jsxs(r.Fragment,{children:[C&&r.jsx("style",{children:`
          .${h} {
            display: flex;
            flex-direction: ${S};
            gap: ${j};
        ...
        `}),r.jsx("div",{className:C?h:void 0,style:C?f:{display:"flex",flexDirection:S,gap:j,alignItems:c,justifyContent:p,...f},children:i})]})}function fx(){const{resolvedTheme:i}=Cl(),a=i==="dark";return r.jsxs(r.Fragment,{children:[r.jsx("style",{children:`
        .footer-container {
      ...
      `}),r.jsx("footer",{className:"footer-container",children:r.jsx(he,{children:r.jsxs(Se,{gap:"24px",children:[r.jsxs("div",{className:"footer-top",children:[r.jsx(mx,{}),r.jsx(hx,{})]}),r.jsxs("div",{className:"footer-bottom",children:[r.jsx(gx,{isDark:a}),r.jsx(xx,{})]})]})})})]})}function mx(){return r.jsxs(Se,{gap:"10px",children:[r.jsx("div",{style:{fontSize:"12px",lineHeight:"18px",fontWeight:"600",color:"var(--muted-foreground)"},children:"Explore"}),r.jsxs(Se,{gap:"10px",children:[r.jsx("a",{href:"#products",style:{fontSize:"14px",lineHeight:"20px",fontWeight:"500",color:"var(--foreground)",textDecoration:"none"},children:"Products"}),r.jsx("a",{href:"#philosophy",style:{fontSize:"14px",lineHeight:"20px",fontWeight:"500",color:"var(--foreground)",textDecoration:"none"},children:"Philosophy"}),r.jsx("a",{href:"#community",style:{fontSize:"14px",lineHeight:"20px",fontWeight:"500",color:"var(--foreground)",textDecoration:"none"},children:"Community"}),r.jsx("a",{href:"/privacy",style:{fontSize:"14px",lineHeight:"20px",fontWeight:"500",color:"var(--foreground)",textDecoration:"none"},children:"Privacy Policy"})]})]})}function hx(){return r.jsxs(Se,{gap:"10px",children:[r.jsx("div",{style:{fontSize:"12px",lineHeight:"18px",fontWeight:"600",color:"var(--muted-foreground)"},children:"Standards"}),r.jsxs(Se,{gap:"10px",children:[r.jsx("div",{style:{fontSize:"14px",lineHeight:"20px",fontWeight:"500",color:"var(--foreground)"},children:"Curated for durability"}),r.jsx("div",{style:{fontSize:"14px",lineHeight:"20px",fontWeight:"500",color:"var(--foreground)"},children:"Reliable support"}),r.jsx("div",{style:{fontSize:"14px",lineHeight:"20px",fontWeight:"500",color:"var(--foreground)"},children:"Clear policies"})]})]})}function gx({isDark:i}){return r.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px"},children:[r.jsx(zd,{size:24,variant:i?"light":"dark",showText:!1,href:"/"}),r.jsx("div",{style:{fontSize:"14px",lineHeight:"20px",color:"var(--muted-foreground)"},children:"© VIBE STATION"})]})}function xx(){return r.jsxs("div",{className:"footer-social",children:[r.jsx("button",{className:"footer-social-btn",children:"Instagram"}),r.jsx("button",{className:"footer-social-btn",children:"YouTube"}),r.jsx("button",{className:"footer-social-btn",children:"Email"})]})}function yx({children:i}){return r.jsxs(Se,{gap:"0px",style:{minHeight:"100vh"},children:[r.jsx(vx,{}),r.jsx(wx,{children:i}),r.jsx(kx,{})]})}function vx(){return r.jsx(ox,{})}function wx({children:i}){return r.jsx(Sx,{children:i})}function kx(){return r.jsx(fx,{})}function Sx({children:i}){return r.jsx("main",{style:{flex:1,backgroundColor:"var(--background)"},children:r.jsx(Se,{gap:"0px",style:{height:"100%"},children:i})})}const jx={standard:{top:"56px",bottom:"56px"},dense:{top:"32px",bottom:"32px"}},$o={canvas:{backgroundColor:"var(--surface-canvas, #FFFFFF)"},subtle:{backgroundColor:"var(--surface-subtle, #FCFCFD)"},inverse:{backgroundColor:"var(--surface-inverse, #101828)",color:"var(--text-inverse, #FFFFFF)"}};function bx(i){if(!i||typeof i!="object"||!("type"in i))return!1;const a=i.type;return a===he||a===he.Wide||a===he.Standard||a===he.Narrow}function rp({children:i}){return r.jsx(r.Fragment,{children:i})}function Cx({children:i}){return r.jsx("div",{style:{paddingTop:"56px",paddingBottom:"56px"},children:i})}function Ex({children:i}){return r.jsx("div",{style:{paddingTop:"32px",paddingBottom:"32px"},children:i})}function Ix({children:i}){return r.jsx("div",{style:$o.canvas,children:i})}function Tx({children:i}){return r.jsx("div",{style:$o.subtle,children:i})}function Fx({children:i}){return r.jsx("div",{style:$o.inverse,children:i})}function _x({children:i,className:a,padding:l="standard",variant:c="canvas",containerWidth:p="standard",contain:f=!0,paddingTop:m,paddingBottom:x,background:S}){const j=jx[l],C=m??j.top,h=x??j.bottom,w={...$o[c],backgroundColor:S??$o[c].backgroundColor},T=f&&!bx(i);return r.jsxs(r.Fragment,{children:[r.jsx("style",{children:`
        .section-responsive {
          padding-top: ${C};
          padding-bottom: ${h};
        }
      ...
      `}),r.jsx("section",{className:`section-responsive ${a||""}`,style:w,children:r.jsx(rp,{children:T?r.jsx(he,{width:p,children:i}):i})})]})}const ot=Object.assign(_x,{SectionContainerSlot:rp,PaddingStandard:Cx,PaddingDense:Ex,VariantCanvas:Ix,VariantSubtle:Tx,VariantInverse:Fx});function Rx(){return r.jsx(ot,{paddingTop:"48px",paddingBottom:"64px",background:"var(--background)",children:r.jsxs(he,{children:[r.jsx(Nx,{}),r.jsx(zx,{})]})})}function Nx(){return r.jsxs(Se,{gap:"0px",style:{marginBottom:"24px"},children:[r.jsx(Ax,{}),r.jsx(Px,{})]})}function zx(){return r.jsxs(Se,{gap:"16px",children:[r.jsx(Lx,{}),r.jsx(Dx,{}),r.jsx(Mx,{}),r.jsx(Ox,{}),r.jsx(Bx,{})]})}function Ax(){return null}function Px(){return null}function Lx(){return null}function Dx(){return null}function Mx(){return null}function Ox(){return null}function Bx(){return null}function $x(){return r.jsx(ot,{paddingTop:"64px",paddingBottom:"80px",background:"var(--card)",children:r.jsxs(he,{children:[r.jsx(Ux,{}),r.jsx(Hx,{})]})})}function Ux(){return r.jsx(Se,{gap:"0px",style:{marginBottom:"24px"},children:r.jsx(Wx,{})})}function Hx(){return r.jsxs(Se,{gap:"16px",children:[r.jsx(Vx,{}),r.jsx(qx,{}),r.jsx(Qx,{})]})}function Wx(){return null}function Vx(){return null}function qx(){return null}function Qx(){return null}const Yx={hero:null,heroMetaBadges:[],featuredDrop:null,socialProof:null};let as=Yx,cs=!1,Eo=null;const Kx=async()=>Eo||(Eo=(async()=>{var i,a,l,c;try{const p=await Oo({first:6});if(p.edges.length===0){cs=!0;return}const f=p.edges.map(j=>j.node),m=f[0],x=ms(m),S=f.slice(0,3).map(j=>{var C,h;return{id:j.id,name:j.title,role:((C=j.featureLine)==null?void 0:C.value)||"Curated product",quote:((h=j.shortDescription)==null?void 0:h.value)||j.description||"Built for consistent daily use.",tag:j.tags[0]||"Curated"}});as={hero:{eyebrow:"Curated essentials for musicians",headline:"Gear that survives practice, travel, and stage.",supporting:"We research what musicians actually need, then pick durable, best-in-class tools with modern features so you buy once and keep playing.",primaryCta:"Shop products",secondaryCta:"Our philosophy",metaLine:"Fast delivery · Clear returns · Responsive support",featuredDropEyebrow:"Featured drop",featuredDropTitle:m.title,featuredDropSubtitle:((i=m.shortDescription)==null?void 0:i.value)||m.description||"",featuredDropImageUrl:(x==null?void 0:x.url)||"",featuredDropImageAlt:(x==null?void 0:x.altText)||m.title},featuredDrop:{eyebrow:"Featured drop",title:"Best-in-class essentials, chosen to last.",supporting:"One product at a time. Thorough research. Durable materials. Modern features that matter in real practice and gig conditions.",badges:["Durable build","Fast + accurate","Stage-ready"],primaryCta:"View featured",secondaryCta:"See all products",productName:m.title,productPrice:new Intl.NumberFormat("en-IN",{style:"currency",currency:m.priceRange.minVariantPrice.currencyCode,maximumFractionDigits:0}).format(Number.parseFloat(m.priceRange.minVariantPrice.amount)),productCopy:((a=m.shortDescription)==null?void 0:a.value)||m.description||"",featureLine:((l=m.featureLine)==null?void 0:l.value)||"",productBadge:((c=m.badge)==null?void 0:c.value)||m.tags[0]||"",productImageUrl:(x==null?void 0:x.url)||"",productImageAlt:(x==null?void 0:x.altText)||m.title},heroMetaBadges:["Curated for durability","Modern features","Clear policies"],socialProof:{eyebrow:"What musicians notice",title:"Built for real use — not shelf appeal.",supporting:"Feedback that focuses on durability, clarity, and daily reliability.",chips:m.tags.slice(0,4),testimonials:S,ctaLabel:"Explore products"}}}catch(p){console.error("Failed to load home data from Shopify",p)}finally{cs=!0,Eo=null}})(),Eo);function Ho(){const[i,a]=_.useState(as),[l,c]=_.useState(!cs);return _.useEffect(()=>{let p=!1;return cs?(a(as),c(!1),()=>{p=!0}):(Kx().then(()=>{p||(a(as),c(!1))}),()=>{p=!0})},[]),{...i,isLoading:l}}function Xx(){const{hero:i}=Ho();return i?r.jsx(ot,{contain:!1,paddingTop:"56px",paddingBottom:"48px",background:"var(--card)",children:r.jsxs("div",{style:{position:"relative",overflow:"hidden"},children:[r.jsx("div",{style:{position:"absolute",top:"-200px",right:"-200px",width:"600px",height:"600px",backgroundColor:"#4F46E50F",borderRadius:"50%",filter:"blur(120px)",pointerEvents:"none",zIndex:0}}),r.jsx(he,{width:"wide",className:"relative z-[1]",children:r.jsxs("div",{style:{display:"flex",flexDirection:"row",gap:"64px",alignItems:"center"},children:[r.jsx("div",{style:{flex:"0 0 55%"},children:r.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[r.jsx("div",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"12px",lineHeight:"18px",fontWeight:"500",color:"var(--muted-foreground)"},children:i.eyebrow}),r.jsx("h1",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"48px",lineHeight:"56px",fontWeight:"600",color:"var(--foreground)",letterSpacing:"-0.01em",margin:0},children:i.headline}),r.jsx("p",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"18px",lineHeight:"28px",fontWeight:"400",color:"var(--muted-foreground)",maxWidth:"540px",margin:0},children:i.supporting}),r.jsxs("div",{style:{display:"flex",gap:"12px",marginTop:"8px"},children:[r.jsx(Gx,{label:i.primaryCta}),r.jsx(Jx,{label:i.secondaryCta})]}),r.jsx("div",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"14px",lineHeight:"20px",fontWeight:"400",color:"var(--muted-foreground)",marginTop:"8px"},children:i.metaLine})]})}),r.jsx("div",{style:{flex:"0 0 45%",position:"relative"},children:r.jsxs("div",{style:{backgroundColor:"var(--card)",border:"1px solid var(--border)",borderRadius:"16px",width:"480px",height:"420px",boxShadow:"0 1px 2px 0 #1018280A, 0 1px 3px 0 #1018280F",overflow:"hidden"},children:[r.jsx("div",{style:{backgroundColor:"var(--muted)",height:"280px",width:"100%"},children:i.featuredDropImageUrl?r.jsx("img",{src:i.featuredDropImageUrl,alt:i.featuredDropImageAlt||i.featuredDropTitle,style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}}):null}),r.jsx("div",{style:{padding:"20px"},children:r.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"8px"},children:[r.jsx("div",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"12px",lineHeight:"18px",fontWeight:"500",color:"var(--muted-foreground)"},children:i.featuredDropEyebrow}),r.jsx("div",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"22px",lineHeight:"30px",fontWeight:"600",color:"var(--foreground)"},children:i.featuredDropTitle}),r.jsx("div",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"14px",lineHeight:"20px",fontWeight:"400",color:"var(--muted-foreground)"},children:i.featuredDropSubtitle})]})})]})})]})})]})}):null}function Gx({label:i}){return r.jsx("button",{style:{height:"44px",paddingLeft:"16px",paddingRight:"16px",borderRadius:"12px",backgroundColor:"#4338CA",color:"#FFFFFF",fontSize:"14px",lineHeight:"20px",fontWeight:"600",border:"none",display:"inline-flex",alignItems:"center",justifyContent:"center",cursor:"pointer",fontFamily:"Inter, system-ui, sans-serif"},children:i})}function Jx({label:i}){return r.jsx("button",{style:{height:"44px",paddingLeft:"16px",paddingRight:"16px",borderRadius:"12px",backgroundColor:"var(--card)",color:"var(--foreground)",fontSize:"14px",lineHeight:"20px",fontWeight:"600",border:"1px solid var(--border)",display:"inline-flex",alignItems:"center",justifyContent:"center",cursor:"pointer",fontFamily:"Inter, system-ui, sans-serif"},children:i})}function op({children:i,wrap:a="on",gap:l=12,align:c="center",justify:p="flex-start",style:f,responsiveGap:m}){const x=typeof l=="number"?`${l}px`:l,S=!!m,j=S?`cluster-${Math.random().toString(36).substr(2,9)}`:"";return r.jsxs(r.Fragment,{children:[S&&r.jsx("style",{children:`
        ...
        `}),r.jsx("div",{className:S?j:void 0,style:S?f:{display:"flex",flexDirection:"row",flexWrap:a==="on"?"wrap":"nowrap",gap:x,alignItems:c,justifyContent:p,...f},children:i})]})}function Zx(){const{heroMetaBadges:i}=Ho();return i.length===0?null:r.jsx(ot,{contain:!1,paddingTop:"24px",paddingBottom:"24px",background:"var(--card)",children:r.jsx(he,{width:"wide",children:r.jsx(op,{wrap:"on",gap:12,align:"center",children:i.map(a=>r.jsx(it,{label:a,variant:"neutral",size:"md"},a))})})})}function ey(){const{featuredDrop:i}=Ho();return i?r.jsx(ot,{paddingTop:"56px",paddingBottom:"56px",background:"var(--background)",children:r.jsx(he,{children:r.jsxs("div",{style:{display:"flex",flexDirection:"row",gap:"48px",alignItems:"flex-start"},children:[r.jsx("div",{style:{flex:"0 0 45%"},children:r.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"14px"},children:[r.jsx("div",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"12px",lineHeight:"18px",fontWeight:"500",color:"var(--muted-foreground)"},children:i.eyebrow}),r.jsx("h2",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"36px",lineHeight:"44px",fontWeight:"600",color:"var(--foreground)",margin:0},children:i.title}),r.jsx("p",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"18px",lineHeight:"28px",fontWeight:"400",color:"var(--muted-foreground)",maxWidth:"480px",margin:0},children:i.supporting}),r.jsx("div",{style:{display:"flex",gap:"10px",marginTop:"6px"},children:i.badges.map(a=>r.jsx(it,{label:a,variant:"neutral",size:"md"},a))}),r.jsxs("div",{style:{display:"flex",gap:"12px",marginTop:"8px"},children:[r.jsx(ty,{label:i.primaryCta}),r.jsx(ny,{label:i.secondaryCta})]})]})}),r.jsx("div",{style:{flex:"0 0 55%"},children:r.jsxs("div",{style:{backgroundColor:"var(--card)",border:"1px solid var(--border)",borderRadius:"16px",width:"560px",height:"360px",boxShadow:"0 1px 2px 0 #1018280A, 0 1px 3px 0 #1018280F",overflow:"hidden"},children:[r.jsx("div",{style:{backgroundColor:"var(--muted)",height:"200px",width:"100%"},children:i.productImageUrl?r.jsx("img",{src:i.productImageUrl,alt:i.productImageAlt||i.productName,style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}}):null}),r.jsx("div",{style:{padding:"16px"},children:r.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"10px"},children:[r.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[r.jsx("div",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"22px",lineHeight:"30px",fontWeight:"600",color:"var(--foreground)"},children:i.productName}),r.jsx("div",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"22px",lineHeight:"30px",fontWeight:"600",color:"var(--foreground)"},children:i.productPrice})]}),r.jsx("p",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"14px",lineHeight:"20px",fontWeight:"400",color:"var(--muted-foreground)",margin:0},children:i.productCopy}),r.jsx("div",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"14px",lineHeight:"20px",fontWeight:"400",color:"var(--muted-foreground)"},children:i.featureLine}),r.jsx("div",{style:{marginTop:"2px"},children:r.jsx(it,{label:i.productBadge,variant:"accent",size:"sm"})})]})})]})})]})})}):null}function ty({label:i}){return r.jsx("button",{style:{height:"44px",paddingLeft:"16px",paddingRight:"16px",borderRadius:"12px",backgroundColor:"#4338CA",color:"#FFFFFF",fontSize:"14px",lineHeight:"20px",fontWeight:"600",border:"none",display:"inline-flex",alignItems:"center",justifyContent:"center",cursor:"pointer",fontFamily:"Inter, system-ui, sans-serif"},children:i})}function ny({label:i}){return r.jsx("button",{style:{height:"44px",paddingLeft:"16px",paddingRight:"16px",borderRadius:"12px",backgroundColor:"var(--card)",color:"var(--foreground)",fontSize:"14px",lineHeight:"20px",fontWeight:"600",border:"1px solid var(--border)",display:"inline-flex",alignItems:"center",justifyContent:"center",cursor:"pointer",fontFamily:"Inter, system-ui, sans-serif"},children:i})}function ry(){return null}function oy(){return null}function iy(){return null}function sy(){return null}function ay(){const{socialProof:i}=Ho();return i?r.jsx(ot,{paddingTop:"56px",paddingBottom:"56px",background:"var(--card)",children:r.jsxs(he,{children:[r.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px",marginBottom:"24px"},children:[r.jsx("div",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"12px",lineHeight:"18px",fontWeight:"500",color:"var(--muted-foreground)"},children:i.eyebrow}),r.jsx("h2",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"36px",lineHeight:"44px",fontWeight:"600",color:"var(--foreground)",margin:0},children:i.title}),r.jsx("p",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"18px",lineHeight:"28px",fontWeight:"400",color:"var(--muted-foreground)",margin:0},children:i.supporting})]}),r.jsx("div",{style:{display:"flex",gap:"12px",marginBottom:"32px"},children:i.chips.map(a=>r.jsx(it,{label:a,variant:"neutral",size:"md"},a))}),r.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(3, 1fr)",gap:"16px",marginBottom:"32px"},children:i.testimonials.map(a=>r.jsx("div",{style:{backgroundColor:"var(--card)",border:"1px solid var(--border)",borderRadius:"16px",width:"100%",minHeight:"220px",boxShadow:"0 1px 2px 0 #1018280A, 0 1px 3px 0 #1018280F",padding:"20px"},children:r.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"10px"},children:[r.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"2px"},children:[r.jsx("div",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"14px",lineHeight:"20px",fontWeight:"600",color:"var(--foreground)"},children:a.name}),r.jsx("div",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"12px",lineHeight:"18px",fontWeight:"500",color:"var(--muted-foreground)"},children:a.role})]}),r.jsx("p",{style:{fontFamily:"Inter, system-ui, sans-serif",fontSize:"16px",lineHeight:"24px",fontWeight:"400",color:"var(--muted-foreground)",margin:0,flex:1},children:a.quote}),r.jsx("div",{children:r.jsx(it,{label:a.tag,variant:"neutral",size:"sm"})})]})},a.id))}),r.jsx("div",{style:{display:"flex",justifyContent:"center"},children:r.jsx(ly,{label:i.ctaLabel})})]})}):null}function ly({label:i}){return r.jsx("button",{style:{height:"44px",paddingLeft:"16px",paddingRight:"16px",borderRadius:"12px",backgroundColor:"var(--card)",color:"var(--foreground)",fontSize:"14px",lineHeight:"20px",fontWeight:"600",border:"1px solid var(--border)",display:"inline-flex",alignItems:"center",justifyContent:"center",cursor:"pointer",fontFamily:"Inter, system-ui, sans-serif"},children:i})}function uy(){return null}function cy(){return null}function dy(){return null}function xe({width:i="100%",height:a="16px",borderRadius:l="8px",style:c,...p}){const f={width:i,height:a,borderRadius:l,background:"linear-gradient(90deg, var(--skeleton-base) 25%, var(--skeleton-highlight) 37%, var(--skeleton-base) 63%)",backgroundSize:"400% 100%",animation:"vs-skeleton-shimmer 1.2s ease-in-out infinite"};return r.jsxs(r.Fragment,{children:[r.jsx("style",{children:`
        @keyframes vs-skeleton-shimmer {
          0% { background-position: 100% 50%; }
          100% { background-position: 0 50%; }
        }
      `}),r.jsx("div",{"aria-hidden":"true",style:{...f,...c},...p})]})}function py(){return r.jsxs(Se,{gap:"0px",children:[r.jsx(ot,{paddingTop:"56px",paddingBottom:"48px",background:"var(--background)",children:r.jsx(he,{children:r.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1.3fr 1fr",gap:"48px"},children:[r.jsxs(Se,{gap:"16px",children:[r.jsx(xe,{width:"140px",height:"14px"}),r.jsx(xe,{width:"88%",height:"56px",borderRadius:"12px"}),r.jsx(xe,{width:"92%",height:"24px"}),r.jsx(xe,{width:"80%",height:"24px"}),r.jsxs("div",{style:{display:"flex",gap:"12px"},children:[r.jsx(xe,{width:"136px",height:"44px",borderRadius:"12px"}),r.jsx(xe,{width:"136px",height:"44px",borderRadius:"12px"})]})]}),r.jsx(xe,{width:"100%",height:"420px",borderRadius:"16px"})]})})}),r.jsx(ot,{paddingTop:"48px",paddingBottom:"56px",background:"var(--background)",children:r.jsx(he,{children:r.jsxs(Se,{gap:"16px",children:[r.jsx(xe,{width:"180px",height:"18px"}),r.jsx(xe,{width:"56%",height:"32px"}),r.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(3, 1fr)",gap:"16px"},children:[1,2,3].map(i=>r.jsx(xe,{height:"240px",borderRadius:"16px"},i))})]})})})]})}function fy(){return r.jsx(ot,{paddingTop:"48px",paddingBottom:"64px",background:"var(--background)",children:r.jsx(he,{children:r.jsxs(Se,{gap:"16px",children:[r.jsx(xe,{width:"96px",height:"14px"}),r.jsx(xe,{width:"180px",height:"40px"}),r.jsx(xe,{width:"420px",height:"24px"}),r.jsx(xe,{width:"100%",height:"44px",borderRadius:"12px"}),r.jsx("div",{style:{display:"flex",gap:"12px"},children:[1,2,3,4].map(i=>r.jsx(xe,{width:"112px",height:"36px",borderRadius:"999px"},i))}),r.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(3, 1fr)",gap:"16px"},children:[1,2,3,4,5,6].map(i=>r.jsx(xe,{height:"460px",borderRadius:"16px"},i))})]})})})}function my(){return r.jsxs(Se,{gap:"0px",children:[r.jsx(ot,{paddingTop:"24px",paddingBottom:"16px",background:"var(--card)",children:r.jsx(he,{children:r.jsx(xe,{width:"280px",height:"16px"})})}),r.jsx(ot,{paddingTop:"16px",paddingBottom:"32px",background:"var(--card)",children:r.jsx(he,{children:r.jsxs(Se,{gap:"12px",children:[r.jsx(xe,{width:"120px",height:"14px"}),r.jsx(xe,{width:"52%",height:"36px"}),r.jsx(xe,{width:"72%",height:"22px"})]})})}),r.jsx(ot,{paddingTop:"24px",paddingBottom:"48px",background:"var(--background)",children:r.jsx(he,{children:r.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 420px",gap:"48px"},children:[r.jsx(xe,{width:"100%",height:"560px",borderRadius:"16px"}),r.jsx(xe,{width:"100%",height:"560px",borderRadius:"16px"})]})})}),r.jsx(ot,{paddingTop:"48px",paddingBottom:"56px",background:"var(--card)",children:r.jsx(he,{children:r.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(3, 1fr)",gap:"16px"},children:[1,2,3].map(i=>r.jsx(xe,{height:"220px",borderRadius:"16px"},i))})})})]})}function hy(){return r.jsx(ot,{paddingTop:"80px",paddingBottom:"80px",background:"var(--muted)",children:r.jsx(he,{children:r.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1.8fr 1fr",gap:"24px",alignItems:"start"},children:[r.jsxs(Se,{gap:"20px",children:[r.jsx(xe,{width:"180px",height:"38px"}),[1,2].map(i=>r.jsx(xe,{width:"100%",height:"164px",borderRadius:"16px"},i)),r.jsx(xe,{width:"100%",height:"300px",borderRadius:"16px"})]}),r.jsxs(Se,{gap:"12px",children:[r.jsx(xe,{width:"100%",height:"260px",borderRadius:"16px"}),r.jsx(xe,{width:"100%",height:"48px",borderRadius:"12px"}),r.jsx(xe,{width:"100%",height:"48px",borderRadius:"12px"})]})]})})})}function gy(){const{isLoading:i}=Ho();return i?r.jsx(py,{}):r.jsxs(r.Fragment,{children:[r.jsx(xy,{}),r.jsx(yy,{})]})}function xy(){return r.jsxs(Se,{gap:"0px",children:[r.jsx(Xx,{}),r.jsx(Zx,{})]})}function yy(){return r.jsxs(Se,{gap:"0px",children:[r.jsx(ey,{}),r.jsx(ry,{}),r.jsx(oy,{}),r.jsx(iy,{}),r.jsx(sy,{}),r.jsx(ay,{}),r.jsx(uy,{}),r.jsx(cy,{}),r.jsx(dy,{})]})}function vy(){return r.jsx(ot,{paddingTop:"48px",paddingBottom:"64px",background:"var(--background)",children:r.jsxs(he,{children:[r.jsx(wy,{}),r.jsx(ky,{})]})})}function wy(){return r.jsxs(Se,{gap:"0px",style:{marginBottom:"24px"},children:[r.jsx(Sy,{}),r.jsx(jy,{})]})}function ky(){return r.jsxs(Se,{gap:"16px",children:[r.jsx(by,{}),r.jsx(Cy,{}),r.jsx(Ey,{}),r.jsx(Iy,{}),r.jsx(Ty,{}),r.jsx(Fy,{}),r.jsx(_y,{}),r.jsx(Ry,{})]})}function Sy(){return null}function jy(){return null}function by(){return null}function Cy(){return null}function Ey(){return null}function Iy(){return null}function Ty(){return null}function Fy(){return null}function _y(){return null}function Ry(){return null}const Ny="http://localhost:3001",os="/api/shopify/admin/product-metadata",zy=i=>`${(os.startsWith("http://")||os.startsWith("https://")?os:`${Ny.replace(/\/+$/,"")}/${os.replace(/^\/+/,"")}`).replace(/\/+$/,"")}/${encodeURIComponent(i)}`;async function Ay(i){const a=await fetch(zy(i),{method:"GET",credentials:"include"});if(!a.ok)throw a.status===429?new Re("Rate limit exceeded","RATE_LIMIT"):new Re(`HTTP ${a.status}`,"HTTP_ERROR");return(await a.json()).product??null}const Ar={productHeader:{badge:"",title:"",vendor:"",sku:"",shareUrl:"",shareLabel:""},productMain:{gallery:{images:[],zoomLabel:"",prevLabel:"",nextLabel:""},buyBox:{variantId:null,badge:"",name:"",descriptor:"",price:"",compareAtPrice:null,stock:"",isInStock:!1,features:[],reassurancePoints:[],primaryCta:"Add to cart",secondaryCta:"Buy now",microLine:"",inBoxTitle:"",inBoxLine:""}},keyBenefits:{title:"",cards:[]},featureDeepDive:{overviewTitle:"",overviewHtml:"",storyTitle:"",storyHtml:"",buyingGuideTitle:"",buyingGuideHtml:"",curatedFor:"",notFor:""},deliveryAndReturns:[],reviews:{title:"",supporting:"",averageLabel:"",averageValue:"",totalReviewsLabel:"",verifiedLabel:"",useCasePrefix:"",writeReviewLabel:"Write a review",loadMoreLabel:"Load more",breakdown:[],tags:[],items:[]},relatedProducts:{title:"Complete your setup",viewAllLabel:"View all",addToCartLabel:"Add to cart",items:[]},specsAndInBox:{specificationsTitle:"",specifications:[],inBoxTitle:"",inBoxItems:[],inBoxBadge:"",productDetailsTitle:"",productDetails:[]},faq:{title:"",items:[]},stickyCtaRail:{variantId:null,name:"",price:"",stockLabel:"",isInStock:!1,shippingLabel:"",reassurancePoints:[],addToCartLabel:"Add to cart",shareLabel:"Share",helpLabel:"Need help?"}},ls="all",Py="All",ip=i=>i.trim().toLowerCase().replace(/&/g,"and").replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,""),Ly="https://thevibestation.com".replace(/\/+$/,""),Dy=["capo","tuner","string","pick","holder","gig bag","bundle","essentials"],sp=i=>{var l,c,p,f;const a=(c=(l=i.variants)==null?void 0:l.edges.find(m=>{const x=m.node;return x.availableForSale&&(typeof x.quantityAvailable!="number"||x.quantityAvailable>0)}))==null?void 0:c.node;return(a==null?void 0:a.id)||((f=(p=i.variants)==null?void 0:p.edges[0])==null?void 0:f.node.id)||null},ap=i=>{var a,l;return((l=(a=i.variants)==null?void 0:a.edges[0])==null?void 0:l.node)??null},us=(i,a)=>{if(!i||!a)return"₹—";const l=Number.parseFloat(i);return Number.isFinite(l)?new Intl.NumberFormat("en-IN",{style:"currency",currency:a,maximumFractionDigits:0}).format(l):`${a} ${i}`},Lr=i=>i?i.replace(/<br\s*\/?>/gi,`
...
`).trim():"",ds=i=>i.replace(/[_-]+/g," ").replace(/\s+/g," ").trim().replace(/\b\w/g,a=>a.toUpperCase()),My=i=>/taxonomy\s*reference/i.test(i),Oy=i=>i.split(">").map(a=>a.trim()).filter(Boolean).at(-1)||i.trim(),is=(i,a)=>{const l=hn(a).replace(/\s*\n+\s*/g," ").replace(/\[*"?gid:\/\/shopify\/TaxonomyValue\/\d+"?\]*/gi,"").replace(/\s*,\s*,+/g,", ").replace(/\(\s*,/g,"(").replace(/,\s*\)/g,")").replace(/\s{2,}/g," ").replace(/^,\s*|\s*,\s*$/g,"").trim();return l?/^label$/i.test(i)?l:/^color$/i.test(i)?`(${l})`:l:""},kd=i=>i.replace(/\[*"?gid:\/\/shopify\/TaxonomyValue\/\d+"?\]*/gi,"").replace(/\s*\|\s*/g," | ").replace(/\s*,\s*\|/g," |").replace(/\|\s*,\s*/g,"| ").replace(/\s*,\s*,+/g,", ").replace(/\(\s*,/g,"(").replace(/,\s*\)/g,")").replace(/\s{2,}/g," ").replace(/^,\s*|\s*,\s*$/g,"").trim(),By=i=>{var f;const a=i.fields.filter(m=>m.value&&m.value.trim().length>0&&!My(m.key));if(a.length===0)return((f=i.displayName)==null?void 0:f.trim())||"";const l=a.find(m=>/^label$/i.test(m.key)),c=a.find(m=>/^color$/i.test(m.key)),p=a.filter(m=>!/^label$/i.test(m.key)&&!/^color$/i.test(m.key));if(l){const m=[is(l.key,l.value??""),...c?[is(c.key,c.value??"")]:[]].filter(Boolean);if(p.length===0&&m.length>0)return m.join(" ");const x=p.map(S=>is(S.key,S.value??"")).filter(Boolean);return[...m,...x].join(", ")}return a.map(m=>is(m.key,m.value??"")).filter(Boolean).join(", ")},$y=i=>hn(i).replace(/<br\s*\/?>/gi,`
`).split(`
`).map(a=>Lr(a).trim()).filter(Boolean),ol=i=>$y(i).map(a=>{const l=a.match(/^([^:]+):\s*(.+)$/);return l?{label:ds(l[1]),value:hn(l[2]).replace(/\s*\n+\s*/g," ").trim()}:null}).filter(a=>!!a&&a.value.length>0),Sd=i=>{const a=hn(i);return a?a.replace(/<br\s*\/?>/gi,`
`).split(/\n{2,}/).map(c=>c.trim()).filter(Boolean).map(c=>{const p=c.split(`
`).map(S=>Lr(S).trim()).filter(Boolean);if(p.length===0)return"";if(p.length>1&&p[0].endsWith(":")){const S=`<p><strong>${fn(p[0])}</strong></p>`,j=p.slice(1).map(C=>`<li>${fn(C)}</li>`).join("");return j?`${S}<ul>${j}</ul>`:S}const f=[];let m=[];const x=()=>{m.length!==0&&(f.push(`<p>${fn(m.join(" "))}</p>`),m=[])};return p.forEach(S=>{const j=S.match(/^([^:]{1,60}):\s*(.+)$/);if(j){x(),f.push(`<p><strong>${fn(j[1].trim())}:</strong> ${fn(j[2].trim())}</p>`);return}m.push(S)}),x(),f.join("")}).join(""):""},Uy=i=>{const a=i.trim();return a.startsWith("[")||a.includes("•")||a.includes("|")},lp=i=>{const a=typeof i.type=="string"?i.type:"",l=typeof i.value=="string"?fn(i.value):"",c=Array.isArray(i.children)?i.children.map(p=>p&&typeof p=="object"?lp(p):"").join(""):"";switch(a){case"root":return c;case"paragraph":return`<p>${c}</p>`;case"heading":return`<h3>${c}</h3>`;case"text":return l;case"text_bold":return`<strong>${c||l}</strong>`;case"text_italic":return`<em>${c||l}</em>`;case"list":return`<ul>${c}</ul>`;case"list-item":return`<li>${c}</li>`;case"link":return typeof i.url=="string"?`<a href="${fn(i.url)}">${c}</a>`:c;default:return c||l}},il=i=>{if(!i)return"";const a=hn(i);if(Uy(a)){const l=ps(a);if(l.length>0)return`<ul>${l.map(c=>`<li>${fn(c)}</li>`).join("")}</ul>`}if(a.includes("<"))return a;try{const l=JSON.parse(a);if(l&&typeof l=="object")return lp(l)}catch{return Sd(a)}return Sd(a)},ps=i=>{const a=hn(i);if(!a)return[];const l=c=>c.replace(/<br\s*\/?>/gi,`
`).split(/\n|,|\||•/).map(p=>Lr(p).trim()).filter(Boolean);try{const c=JSON.parse(a);if(Array.isArray(c))return c.flatMap(p=>typeof p=="string"?l(p):[]).filter(Boolean);if(typeof c=="string")return l(c)}catch{return l(a)}return[]},Hy=i=>{const a=hn(i);if(!a)return[];try{const l=JSON.parse(a);if(l&&typeof l=="object"&&!Array.isArray(l)){const c=Object.entries(l).flatMap(([p,f])=>{const m=ol(`${ds(p)}: ${String(f)}`);return m.length>0?m:[{label:ds(p),value:hn(String(f)).replace(/\s*\n+\s*/g," ").trim()}]}).filter(p=>p.value.length>0);if(c.length>0)return c}}catch{return ol(a)}return ol(a)},Wy=i=>{if(!i)return[];try{const a=JSON.parse(i);if(Array.isArray(a))return a.map(l=>{if(!l||typeof l!="object")return null;const c=l,p=typeof c.question=="string"?c.question.trim():"",f=typeof c.answer=="string"?c.answer.trim():"";return p&&f?{question:p,answer:f}:null}).filter(l=>!!l)}catch{return i.replace(/<br\s*\/?>/gi,`
`).split(/\n{2,}/).map(l=>Lr(l)).filter(Boolean).map(l=>{const[c,...p]=l.split(`
`),f=p.join(" ").trim();return!c||!f?null:{question:c.replace(/^Q[:\-]?\s*/i,""),answer:f.replace(/^A[:\-]?\s*/i,"")}}).filter(l=>!!l)}return[]},pl=(i,a="Yes",l="No")=>{if(!i)return"";const c=i.trim().toLowerCase();return["true","yes","available","1"].includes(c)?a:["false","no","not available","0"].includes(c)?l:i.trim()},up=()=>{if(typeof window>"u")return null;const i=window.location.pathname.match(/\/products\/([^/]+)/);return(i==null?void 0:i[1])??null},cp=i=>`${Ly}/products/${i.handle}`,Vy=i=>{var c;if(i.availableForSale===!1)return"Out of stock";if(typeof i.totalInventory=="number")return i.totalInventory>0?`In stock (${i.totalInventory} available)`:"Out of stock";const a=ap(i);return a&&typeof a.quantityAvailable=="number"?a.quantityAvailable>0?`In stock (${a.quantityAvailable} available)`:"Out of stock":((c=i.variants)==null?void 0:c.edges.some(p=>{const f=p.node;return f.availableForSale===!1?!1:typeof f.quantityAvailable=="number"?f.quantityAvailable>0:f.availableForSale===!0}))?"In stock":"Out of stock"},qy=i=>{var l;return ps((l=i.whyDifferent)==null?void 0:l.value).slice(0,3).map((c,p)=>({id:`${i.handle}-feature-${p}`,badge:`0${p+1}`,title:c,description:"",footer:""}))},Qy=i=>{const a=`${i.title} ${i.tags.join(" ")}`.toLowerCase();return Dy.some(l=>a.includes(l))?"Pair it with these":"Complete your setup"},Yy=i=>{var c;const a={averageValue:"—",totalReviewsLabel:"No reviews yet",breakdown:[],tags:[],items:[]},l=(c=i.reviewSummary)==null?void 0:c.value;if(!l)return a;try{const p=JSON.parse(l),f=typeof p.average=="number"?p.average.toFixed(1):"—",m=typeof p.count=="number"?p.count:0,x=Array.isArray(p.breakdown)?p.breakdown:[],S=Array.isArray(p.items)?p.items:[],j=Array.isArray(p.tags)?p.tags:[];return{averageValue:f,totalReviewsLabel:`${m} review${m===1?"":"s"}`,breakdown:x.map(C=>{if(!C||typeof C!="object")return null;const h=C,w=typeof h.stars=="number"?h.stars:0,T=typeof h.count=="number"?h.count:0;return w>0?{stars:w,count:T,label:`${w} star`}:null}).filter(C=>!!C).sort((C,h)=>h.stars-C.stars),tags:j.filter(C=>typeof C=="string"),items:S.map((C,h)=>{if(!C||typeof C!="object")return null;const w=C;return{id:typeof w.id=="string"?w.id:`review-${h}`,name:typeof w.name=="string"?w.name:"Verified buyer",role:typeof w.role=="string"?w.role:"Customer",quote:typeof w.quote=="string"?w.quote:"",useCase:typeof w.useCase=="string"?w.useCase:"General use",rating:typeof w.rating=="number"?w.rating:5,tags:Array.isArray(w.tags)?w.tags.filter(T=>typeof T=="string"):[],verified:w.verified!==!1}}).filter(C=>!!C&&C.quote.length>0)}}catch{return a}},Ky=i=>{var l,c,p,f,m,x,S;const a=[(l=i.packCount)==null?void 0:l.value,(c=i.bestFor)==null?void 0:c.value,(p=i.dispatchTime)==null?void 0:p.value,(f=i.deliveryWindow)==null?void 0:f.value,(m=i.returnsPolicy)==null?void 0:m.value,pl((x=i.codAvailable)==null?void 0:x.value,"COD available","COD unavailable"),pl((S=i.secureCheckout)==null?void 0:S.value,"Secure checkout","")].map(j=>j==null?void 0:j.trim()).filter(j=>!!j);return Array.from(new Set(a)).slice(0,6)},Xy=i=>{var l,c,p;const a=ap(i);return[{label:"SKU",value:(a==null?void 0:a.sku)||"Available on request"},{label:"Brand",value:i.vendor||"Vibe Station"},{label:"Country of origin",value:((l=i.countryOfOrigin)==null?void 0:l.value)||""},{label:"GST invoice",value:pl((c=i.gstInvoice)==null?void 0:c.value,"Available","Not specified")||"Not specified"},{label:"Care / storage",value:Lr((p=i.careInstructions)==null?void 0:p.value)},{label:"Shareable short URL",value:cp(i)}].filter(f=>f.value.trim().length>0)},dp=i=>{const a=i==null?void 0:i.trim();if(!a)return[];try{const l=JSON.parse(a);if(Array.isArray(l))return l.map(c=>typeof c=="string"?c.trim():"").filter(c=>c.length>0)}catch{}return a.split(/[\n,]+/).map(l=>l.trim()).filter(Boolean)},jd=i=>{var a;return Array.from(new Set([...dp((a=i.categories)==null?void 0:a.value),...i.tags.map(l=>l.trim()).filter(Boolean)]))},bd=i=>i.map(a=>ip(a)).filter(Boolean),Gy=async i=>{const a=jd(i),l=new Set(bd(a)),c=new Set(a.map(f=>f.toLowerCase()));return l.size===0&&c.size===0?[]:(await Oo({first:50})).edges.map(f=>f.node).filter(f=>f.id!==i.id).map(f=>{const m=jd(f),x=bd(m),S=m.filter(C=>c.has(C.toLowerCase())).length,j=x.filter(C=>l.has(C)).length;return{candidate:f,score:S+j}}).filter(f=>f.score>0).sort((f,m)=>m.score-f.score).slice(0,20).map(f=>f.candidate)},Jy=i=>(i??[]).flatMap(a=>{const l=ds(a.key),c=a.reference?[a.reference]:[],p=Array.isArray(a.references)?a.references:[],f=[...c,...p].map(S=>By(S)).filter(Boolean),m=kd(hn(a.value).replace(/\s*\n+\s*/g," ").trim()),x=kd(f.length>0?f.join(" | "):m);return x.length>0?[{label:l,value:x}]:[]}),Zy=(i,a)=>{var S,j,C,h;const l=Hy((S=i.specifications)==null?void 0:S.value),c=dp((j=i.categories)==null?void 0:j.value),p=((C=a==null?void 0:a.category)==null?void 0:C.fullName)||((h=a==null?void 0:a.category)==null?void 0:h.name)||"",f=Array.from(new Set([...c,...p?[p]:[]].map(w=>Oy(w)).filter(Boolean))),m=f.length>0?[{label:"Category",value:f.join(", ")}]:[],x=Jy(a==null?void 0:a.shopifyMetafields);return[...m,...x,...l].filter((w,T,R)=>{const M=`${w.label.toLowerCase()}::${w.value.toLowerCase()}`;return R.findIndex(A=>`${A.label.toLowerCase()}::${A.value.toLowerCase()}`===M)===T})},e0=(i,a)=>a.filter(l=>l.id!==i.id&&l.handle!==i.handle).slice(0,6).map(l=>{var p,f,m;const c=ms(l);return{id:l.handle,variantId:sp(l),badge:((p=l.badge)==null?void 0:p.value)||l.tags[0]||"Curated",name:l.title,descriptor:((f=l.shortDescription)==null?void 0:f.value)||l.description||"Curated recommendation",featureLine:((m=l.featureLine)==null?void 0:m.value)||l.tags.slice(0,3).join(" · ")||"Pairs well with this setup",price:us(l.priceRange.minVariantPrice.amount,l.priceRange.minVariantPrice.currencyCode),imageUrl:c==null?void 0:c.url,imageAlt:(c==null?void 0:c.altText)||l.title}}),t0=()=>Ar.reviews,n0=({product:i,adminMetadata:a,relatedProducts:l})=>{var U,K,te,re,ee,ae,ve,Te,Le,Be,we,Ne,ze,Ke,Ce,ne,ce,D,V,B,v,F,H,G,ie,X,de,le,pe,Ae,en,yn;const c=((K=(U=i.variants)==null?void 0:U.edges[0])==null?void 0:K.node)??null,p=il((te=i.whyDifferent)==null?void 0:te.value),f=il((re=i.buyingGuide)==null?void 0:re.value),m=il(i.description)||i.descriptionHtml||`<p>${fn(i.description)}</p>`,x=Zy(i,a),S=ps((ee=i.whatsInBox)==null?void 0:ee.value),j=ps((ae=i.bulletFeatures)==null?void 0:ae.value),C=qy(i),h=Vy(i),w=h.toLowerCase().startsWith("in stock"),T=sp(i),R=Yy(i),M=Ky(i),A=cp(i);return{productHeader:{badge:((ve=i.badge)==null?void 0:ve.value)||"Curated pick",title:i.title,vendor:i.vendor||"Vibe Station",sku:(c==null?void 0:c.sku)||"—",shareUrl:A,shareLabel:"Shareable short URL"},productMain:{gallery:{images:i.images.edges.map((kt,Qt)=>({id:kt.node.id||`${i.handle}-${Qt}`,url:kt.node.url,altText:kt.node.altText||`${i.title} image ${Qt+1}`}))||[],zoomLabel:"Zoom",prevLabel:"Prev",nextLabel:"Next"},buyBox:{variantId:T,badge:((Te=i.badge)==null?void 0:Te.value)||"Curated pick",name:i.title,descriptor:((Le=i.subtitle)==null?void 0:Le.value)||((Be=i.shortDescription)==null?void 0:Be.value)||Lr(i.descriptionHtml)||i.description,price:us(i.priceRange.minVariantPrice.amount,i.priceRange.minVariantPrice.currencyCode),compareAtPrice:(we=i.compareAtPriceRange)!=null&&we.minVariantPrice?us(i.compareAtPriceRange.minVariantPrice.amount,i.compareAtPriceRange.minVariantPrice.currencyCode):null,stock:h,isInStock:w,features:j,reassurancePoints:M,primaryCta:((Ne=i.ctaLabel)==null?void 0:Ne.value)||"Add to cart",secondaryCta:((ze=i.ctaSubtext)==null?void 0:ze.value)||"Buy now",microLine:((Ke=i.shippingInfo)==null?void 0:Ke.value)||[(Ce=i.dispatchTime)==null?void 0:Ce.value,(ne=i.supportResponseTime)==null?void 0:ne.value,(ce=i.deliveryWindow)==null?void 0:ce.value].filter(Boolean).join(" · ")||"Shipping calculated at checkout · Clear returns · Responsive support",inBoxTitle:"What's in the box",inBoxLine:S.join(" · ")}},keyBenefits:{title:"Why it feels different",cards:C},featureDeepDive:{overviewTitle:"Product overview",overviewHtml:m,storyTitle:"Why this made the cut",storyHtml:p,buyingGuideTitle:"Buying guide",buyingGuideHtml:f,curatedFor:((D=i.curatedFor)==null?void 0:D.value)||((V=i.bestFor)==null?void 0:V.value)||"Players comparing feel, grip, and attack quickly.",notFor:((B=i.notFor)==null?void 0:B.value)||"Players who already know they only want one exact gauge."},deliveryAndReturns:[{id:"dispatch",badge:"Dispatch",title:"Estimated dispatch",description:((v=i.deliveryInfo)==null?void 0:v.value)||"",footer:((F=i.deliveryWindow)==null?void 0:F.value)||""},{id:"returns",badge:"Returns",title:"Returns & replacements",description:((H=i.returnsPolicy)==null?void 0:H.value)||"",footer:((G=i.replacementPolicy)==null?void 0:G.value)||""},{id:"support",badge:"Support",title:"Support response",description:((ie=i.supportInfo)==null?void 0:ie.value)||"",footer:((X=i.supportResponseTime)==null?void 0:X.value)||""}].filter(kt=>kt.description.trim().length>0||kt.footer.trim().length>0),reviews:{...t0(),supporting:(de=i.reviewSummary)!=null&&de.value?"Real review summary pulled from Shopify metafields.":"Add custom.reviews in Shopify to populate rating, review count, tags, and breakdown.",averageLabel:R.averageValue==="—"?"No rating yet":`${R.averageValue} / 5`,averageValue:R.averageValue,totalReviewsLabel:R.totalReviewsLabel,breakdown:R.breakdown,tags:R.tags,items:R.items},relatedProducts:{...Ar.relatedProducts,title:Qy(i),items:e0(i,l)},specsAndInBox:{specificationsTitle:"Specifications",specifications:x,inBoxTitle:"In the box",inBoxItems:S,inBoxBadge:((le=i.packCount)==null?void 0:le.value)||"No extras required",productDetailsTitle:"Product details",productDetails:Xy(i)},faq:{title:"FAQ",items:Wy((pe=i.faq)==null?void 0:pe.value)},stickyCtaRail:{variantId:T,name:i.title,price:us(i.priceRange.minVariantPrice.amount,i.priceRange.minVariantPrice.currencyCode),stockLabel:h,isInStock:w,shippingLabel:((Ae=i.deliveryWindow)==null?void 0:Ae.value)||((en=i.shippingInfo)==null?void 0:en.value)||"Shipping calculated at checkout",reassurancePoints:M,addToCartLabel:((yn=i.ctaLabel)==null?void 0:yn.value)||"Add to cart",shareLabel:"Share",helpLabel:"Need help?"}}};let ur=Ar,Ao=!1,Io=null,Po=null,No=!1;const r0=async i=>{const a=i??up();return Io&&a===Po||(Io=(async()=>{try{const l=a;if(!l){ur=Ar,No=!1,Ao=!0,Po=null;return}Po=l;const[c,p]=await Promise.all([Vm(l),Ay(l).catch(m=>(console.error("Failed to load public admin product metadata",m),null))]);if(!c){ur=Ar,No=!1,Ao=!0;return}const f=await Gy(c).catch(()=>[]);ur=n0({product:c,adminMetadata:p,relatedProducts:f}),No=!0}catch(l){ur=Ar,No=!1,console.error("Failed to load product detail from Shopify",l)}finally{Ao=!0,Io=null}})()),Io};function qt(){const i=up(),[a,l]=_.useState(ur),[c,p]=_.useState(!Ao||Po!==i);return _.useEffect(()=>{let f=!1;return Ao&&Po===i?(l(ur),p(!1),()=>{f=!0}):(p(!0),r0(i).then(()=>{f||(l(ur),p(!1))}),()=>{f=!0})},[i]),{...a,hasProduct:No,isLoading:c}}function o0(){const{productHeader:i}=qt();return r.jsxs(r.Fragment,{children:[r.jsx("style",{children:`
        .product-title-block {
          display: flex;
          flex-direction: column;
          gap: 14px;
      ...
      `}),r.jsx("nav",{"aria-label":"Breadcrumb",children:r.jsxs("ol",{className:"breadcrumb-nav",children:[r.jsx("li",{children:r.jsx("a",{href:"/",className:"breadcrumb-link",children:"Home"})}),r.jsx("li",{className:"breadcrumb-separator",children:"/"}),r.jsx("li",{children:r.jsx("a",{href:"/products",className:"breadcrumb-link",children:"Products"})}),r.jsx("li",{className:"breadcrumb-separator",children:"/"}),r.jsx("li",{className:"breadcrumb-current",children:i.title})]})})]})}const s0={sm:"12px",md:"16px",lg:"20px"};function a0(i){switch(i){case"subtle":return{backgroundColor:"var(--muted)",border:"1px solid var(--border)",boxShadow:"none"};case"outline":return{backgroundColor:"transparent",border:"1px solid var(--border)",boxShadow:"none"};case"elevated":default:return{backgroundColor:"var(--card)",border:"1px solid var(--border)",boxShadow:"0 1px 2px 0 #1018280A, 0 1px 3px 0 #1018280F"}}}function He({children:i,mediaSlot:a,footerSlot:l,variant:c="elevated",padding:p="md",width:f="100%",height:m}){const x=a0(c),S=s0[p];return r.jsxs("div",{style:{...x,borderRadius:"16px",width:f,height:m,overflow:"hidden",display:"flex",flexDirection:"column"},children:[a,i?r.jsx("div",{style:{padding:S},children:i}):null,l?r.jsx("div",{style:{padding:S,paddingTop:"0"},children:l}):null]})}function l0({children:i}){return r.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"6px",position:"relative"},children:i})}function u0({children:i}){return r.jsx("label",{style:{fontSize:"12px",lineHeight:"18px",fontWeight:"600",color:"var(--muted-foreground)",fontFamily:"Inter, system-ui, sans-serif"},children:i})}function c0({children:i}){return r.jsx("div",{style:{display:"flex",alignItems:"center",position:"relative"},children:i})}function d0({placeholder:i,value:a}){return r.jsx("input",{type:"text",placeholder:i||"Enter text...",value:a,style:{width:"100%",border:"none",outline:"none",background:"transparent",fontSize:"14px",lineHeight:"20px",fontWeight:"400",fontFamily:"Inter, system-ui, sans-serif",color:"var(--foreground)",padding:0}})}function p0({children:i,error:a}){return r.jsx("div",{style:{fontSize:"12px",lineHeight:"18px",fontWeight:"400",color:a?"var(--destructive)":"var(--muted-foreground)",fontFamily:"Inter, system-ui, sans-serif"},children:i})}function f0({label:i,placeholder:a,helperText:l,error:c,disabled:p,size:f="md"}){const m=f==="sm"?"36px":"44px",x=f==="sm"?"12px":"14px",S=f==="sm"?"10px":"12px";let j="var(--border)";return c&&(j="var(--destructive)"),r.jsxs(l0,{children:[i&&r.jsx(u0,{children:i}),r.jsx(c0,{children:r.jsx("div",{style:{width:"100%",height:m,display:"flex",alignItems:"center",paddingLeft:x,paddingRight:x,backgroundColor:"var(--card)",border:`1px solid ${j}`,borderRadius:S,opacity:p?.4:1,transition:"border-color 150ms ease"},children:r.jsx(d0,{placeholder:a})})}),l&&r.jsx("div",{style:{opacity:p?.4:1},children:r.jsx(p0,{error:c,children:l})})]})}function pp(){return r.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"10px"},children:[r.jsx(f0,{label:"Delivery pincode",placeholder:"110001",helperText:"Enter your 6-digit pincode."}),r.jsx("div",{children:r.jsx(We,{variant:"secondary",size:"sm",label:"Check delivery"})})]})}function m0(){return r.jsxs("div",{className:"product-main",children:[r.jsx(h0,{}),r.jsx(g0,{})]})}function h0(){const{productMain:i}=qt(),[a,l]=_.useState(0),c=i.gallery.images,p=c[a],f=()=>{c.length!==0&&l(x=>x===0?c.length-1:x-1)},m=()=>{c.length!==0&&l(x=>(x+1)%c.length)};return r.jsxs("div",{className:"product-main__gallery",children:[r.jsx(He,{variant:"elevated",height:"560px",mediaSlot:r.jsxs("div",{className:"product-main__gallery-frame",children:[p?r.jsx("img",{className:"product-main__gallery-image",src:p.url,alt:p.altText}):r.jsx("div",{className:"product-main__gallery-placeholder"}),r.jsx("div",{className:"product-main__gallery-badge",children:r.jsx(it,{label:i.gallery.zoomLabel,variant:"neutral",size:"sm"})}),r.jsxs("div",{className:"product-main__gallery-actions",children:[r.jsx(We,{variant:"ghost",size:"sm",label:i.gallery.prevLabel,onClick:f}),r.jsx(We,{variant:"ghost",size:"sm",label:i.gallery.nextLabel,onClick:m})]})]})}),r.jsx("div",{className:"product-main__thumbnail-row",children:c.length>0?c.map((x,S)=>r.jsx("button",{className:`product-main__thumbnail-button${S===a?" product-main__thumbnail-button--active":""}`,type:"button",onClick:()=>l(S),children:r.jsx("img",{className:"product-main__thumbnail-image",src:x.url,alt:x.altText})},x.id)):[1,2,3,4].map(x=>r.jsx("div",{className:`product-main__thumbnail-placeholder${x===1?" product-main__thumbnail-placeholder--active":""}`},x))})]})}function g0(){const{addItem:i}=Vn(),{productMain:a}=qt(),l=a.buyBox.isInStock;return r.jsx("div",{className:"product-main__buy-box",children:r.jsx(He,{variant:"elevated",padding:"lg",children:r.jsxs("div",{className:"product-main__buy-box-content",children:[r.jsx("div",{className:"product-main__badge-row",children:r.jsx(it,{label:a.buyBox.badge,variant:"accent",size:"sm"})}),r.jsx("h2",{className:"product-main__title",children:a.buyBox.name}),r.jsx("div",{className:"product-main__descriptor",children:a.buyBox.descriptor}),r.jsxs("div",{className:"product-main__price-row",children:[r.jsx("h3",{className:"product-main__price",children:a.buyBox.price}),r.jsxs("div",{className:"product-main__stock-column",children:[a.buyBox.compareAtPrice?r.jsx("span",{className:"product-main__compare-price",children:a.buyBox.compareAtPrice}):null,r.jsx("span",{className:`product-main__stock${l?" product-main__stock--in-stock":" product-main__stock--out-of-stock"}`,children:a.buyBox.stock})]})]}),r.jsx(pp,{}),a.buyBox.reassurancePoints.length>0?r.jsx("div",{className:"product-main__reassurance-list",children:a.buyBox.reassurancePoints.map(c=>r.jsxs("div",{className:"product-main__reassurance-item",children:[r.jsx("div",{className:"product-main__reassurance-icon",children:r.jsx(Kd,{className:"product-main__reassurance-check",size:12,strokeWidth:3})}),r.jsx("div",{className:"product-main__reassurance-text",children:c})]},c))}):null,r.jsxs("div",{className:"product-main__actions",children:[r.jsx(We,{variant:"primary",size:"lg",label:a.buyBox.primaryCta,disabled:!l||!a.buyBox.variantId,onClick:()=>{a.buyBox.variantId&&i(a.buyBox.variantId)}}),r.jsx(We,{variant:"secondary",size:"lg",label:a.buyBox.secondaryCta})]}),r.jsx("div",{className:"product-main__micro-line",children:a.buyBox.microLine})]})})})}function x0(){const{deliveryAndReturns:i}=qt();return r.jsxs(r.Fragment,{children:[r.jsx("style",{children:`
      ...
      `}),r.jsxs("div",{className:"product-results-header",children:[r.jsxs("div",{className:"results-count",children:["Showing ",r.jsx("span",{className:"results-count-number",children:i})," ","results"]}),r.jsxs("div",{className:"sort-controls",children:[r.jsx("span",{className:"sort-label",children:"Sort by:"}),r.jsxs("div",{className:"sort-dropdown-wrapper",children:[r.jsxs("button",{onClick:()=>l(!a),className:"sort-button",onMouseEnter:m=>{m.currentTarget.style.backgroundColor="var(--muted)",m.currentTarget.style.borderColor="var(--border)"},onMouseLeave:m=>{m.currentTarget.style.backgroundColor="var(--card)",m.currentTarget.style.borderColor="var(--border)"},children:[c,r.jsx(Oh,{size:16,color:"var(--muted-foreground)",style:{transition:"transform 150ms ease",transform:a?"rotate(180deg)":"rotate(0deg)"}})]}),a&&r.jsx("div",{className:"sort-dropdown",children:f.map(m=>r.jsx("button",{onClick:()=>{p(m),l(!1)},className:"sort-option",style:{backgroundColor:c===m?"var(--muted)":"transparent",fontWeight:c===m?"600":"500",color:c===m?"var(--primary)":"var(--muted-foreground)"},onMouseEnter:x=>{c!==m&&(x.currentTarget.style.backgroundColor="var(--muted)")},onMouseLeave:x=>{c!==m&&(x.currentTarget.style.backgroundColor="transparent")},children:m},m))})]})]})]})]})}const av={id:ls,label:Py},lv=i=>{const a=new Set;return i.flatMap(c=>c.categoryIds.map((p,f)=>({id:p,label:c.categoryLabels[f]??c.categoryIds[f]}))).filter(c=>!c.id||a.has(c.id)?!1:(a.add(c.id),!0))};function uv(i){const a=lv(i);return{filters:[av,...a],isLoading:!1,resetLabel:"Reset filters"}}const cv=120,dv=(i,a)=>{const l=Number.parseFloat(i);return Number.isFinite(l)?new Intl.NumberFormat("en-IN",{style:"currency",currency:a,maximumFractionDigits:0}).format(l):`${a} ${i}`},pv=i=>{var a;return i.availableForSale===!1?!1:typeof i.totalInventory=="number"?i.totalInventory>0:((a=i.variants)==null?void 0:a.edges.some(l=>{const c=l.node;return c.availableForSale===!1?!1:typeof c.quantityAvailable=="number"?c.quantityAvailable>0:c.availableForSale===!0}))??!0},fv=i=>{var l,c,p,f;const a=(c=(l=i.variants)==null?void 0:l.edges.find(m=>{const x=m.node;return x.availableForSale&&(typeof x.quantityAvailable!="number"||x.quantityAvailable>0)}))==null?void 0:c.node;return(a==null?void 0:a.id)||((f=(p=i.variants)==null?void 0:p.edges[0])==null?void 0:f.node.id)||null},mv=(i,a=cv)=>{const l=i.replace(/\s+/g," ").trim();return l.length<=a?l:`${l.slice(0,a).trimEnd()}...`},Fd=i=>{var j,C,h,w;const a=((j=i.shortDescription)==null?void 0:j.value)||i.description||"Curated by Vibe Station",l=mv(a),c=((C=i.featureLine)==null?void 0:C.value)||i.tags.slice(0,3).join(" · ")||"Durable build",p=((h=i.shippingInfo)==null?void 0:h.value)||"Shipping calculated at checkout",f=((w=i.badge)==null?void 0:w.value)||i.tags[0]||"Curated",m=ms(i),x=Array.from(new Set(i.tags.map(T=>T.trim()).filter(Boolean))),S=x.map(T=>ip(T)).filter(Boolean);return{id:i.handle,variantId:fv(i),name:i.title,descriptor:l,featureLine:c,priceLabel:dv(i.priceRange.minVariantPrice.amount,i.priceRange.minVariantPrice.currencyCode),shippingLabel:p,isInStock:pv(i),badgeLabel:f,badgeVariant:"accent",imageUrl:m==null?void 0:m.url,imageAlt:m==null?void 0:m.altText,categoryIds:S,categoryLabels:x}};let Lo=[],ml=!1,To=null;const Do=new Map,hl=new Set,al=new Map,fp=i=>(i==null?void 0:i.trim())??"",hv=async i=>{const a=fp(i);if(!a)return To||(To=(async()=>{try{Lo=(await Oo({first:24})).edges.map(f=>Fd(f.node))}catch(p){console.error("Failed to load products from Shopify",p),Lo=[]}finally{ml=!0,To=null}})(),To);const l=al.get(a);if(l)return l;const c=(async()=>{try{const f=(await Oo({first:24,query:a})).edges.map(m=>Fd(m.node));Do.set(a,f)}catch(p){console.error("Failed to load searched products from Shopify",p),Do.set(a,[])}finally{hl.add(a),al.delete(a)}})();return al.set(a,c),c};function gv(i){const a=fp(i),[l,c]=_.useState(a?Do.get(a)??[]:Lo),[p,f]=_.useState(a?!hl.has(a):!ml);return _.useEffect(()=>{let m=!1;return(a?hl.has(a):ml)?(c(a?Do.get(a)??[]:Lo),f(!1),()=>{m=!0}):(f(!0),hv(a).then(()=>{m||(c(a?Do.get(a)??[]:Lo),f(!1))}),()=>{m=!0})},[a]),{products:l,hoverPreviewProduct:l[0],isLoading:p}}function xv(){const[i,a]=_.useState(""),[l,c]=_.useState(""),[p,f]=_.useState(ls),[m,x]=_.useState(!1),{products:S,isLoading:j}=gv(l),{filters:C,resetLabel:h}=uv(S),w=p===ls?S:S.filter(T=>T.categoryIds.includes(p));return _.useEffect(()=>{j||x(!0)},[j]),_.useEffect(()=>{C.some(T=>T.id===p)||f(ls)},[p,C]),!m&&j?r.jsx(fy,{}):r.jsx(ot,{paddingTop:"48px",paddingBottom:"72px",background:"var(--background)",children:r.jsxs(he,{children:[r.jsx(yv,{}),r.jsx(vv,{searchInput:i,onSearchInputChange:a,onSearchSubmit:()=>c(i.trim()),isSearching:j,activeFilter:p,onFilterChange:f,filters:C,resetLabel:h,resultCount:w.length,products:w})]})})}function yv(){return r.jsx(iv,{})}function vv({searchInput:i,onSearchInputChange:a,onSearchSubmit:l,isSearching:c,activeFilter:p,onFilterChange:f,filters:m,resetLabel:x,resultCount:S,products:j}){return r.jsxs(Se,{gap:"16px",children:[r.jsx(E0,{query:i,onQueryChange:a,onSearch:l,isSearching:c}),r.jsx(I0,{filters:m,activeFilter:p,onFilterChange:f,resetLabel:x}),r.jsx(sv,{resultCount:S}),r.jsx(rv,{products:j})]})}function mp({id:i,name:a,variant:l,price:c,quantity:p,imageUrl:f,imageAlt:m,onIncrement:x,onDecrement:S,onRemove:j}){return r.jsx(He,{variant:"subtle",padding:"md",children:r.jsxs("div",{style:{display:"flex",gap:"12px",alignItems:"flex-start"},children:[r.jsx("div",{style:{width:"72px",height:"72px",backgroundColor:"var(--muted)",borderRadius:"12px",flexShrink:0,overflow:"hidden"},children:f?r.jsx("img",{src:f,alt:m||a,style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}}):null}),r.jsxs("div",{style:{flex:1,display:"flex",flexDirection:"column",gap:"6px"},children:[r.jsx("div",{style:{fontSize:"14px",lineHeight:"20px",fontWeight:"600",color:"var(--foreground)",fontFamily:"Inter, system-ui, sans-serif"},children:a}),r.jsx("div",{style:{fontSize:"12px",lineHeight:"18px",fontWeight:"400",color:"var(--muted-foreground)",fontFamily:"Inter, system-ui, sans-serif"},children:l}),r.jsx("div",{style:{fontSize:"14px",lineHeight:"20px",fontWeight:"600",color:"var(--foreground)",fontFamily:"Inter, system-ui, sans-serif"},children:c})]}),r.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"8px",alignItems:"flex-end"},children:[r.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[r.jsx(We,{variant:"ghost",size:"sm",label:"−",onClick:S?()=>S(i):void 0}),r.jsx("div",{style:{fontSize:"14px",lineHeight:"20px",fontWeight:"500",color:"var(--foreground)",fontFamily:"Inter, system-ui, sans-serif",minWidth:"20px",textAlign:"center"},children:p}),r.jsx(We,{variant:"ghost",size:"sm",label:"+",onClick:x?()=>x(i):void 0})]}),r.jsx(We,{variant:"ghost",size:"sm",label:"Remove",onClick:j?()=>j(i):void 0})]})]})})}const wv={title:"Cart",yourCartTitle:"Your cart",addOnsTitle:"Add-ons you may like",summaryTitle:"Order summary",subtotalLabel:"Subtotal",shippingLabel:"Shipping",shippingValue:"Calculated at checkout",totalLabel:"Total",taxesLine:"Taxes and shipping calculated at checkout.",drawerCheckoutLabel:"Checkout",drawerContinueLabel:"Continue shopping",drawerFooterCaption:"You'll complete payment in checkout.",emptyCartMessage:"Your cart is empty.",summaryCheckoutLabel:"Checkout",summaryContinueLabel:"Continue shopping",writeItemSuffix:"items",addButtonLabel:"Add"};let Mo=[],gl=!1,Fo=null;const kv=async()=>Fo||(Fo=(async()=>{try{Mo=(await Oo({first:2})).edges.map(a=>{const l=ms(a.node);return{id:a.node.handle,name:a.node.title,price:Number.parseFloat(a.node.priceRange.minVariantPrice.amount),imageUrl:l==null?void 0:l.url,imageAlt:(l==null?void 0:l.altText)||a.node.title}})}catch(i){console.error("Failed to load cart add-ons from Shopify",i),Mo=[]}finally{gl=!0,Fo=null}})(),Fo);function Wo(){const[i,a]=_.useState(Mo),[l,c]=_.useState(!gl);return _.useEffect(()=>{let p=!1;return gl?(a(Mo),c(!1),()=>{p=!0}):(kv().then(()=>{p||(a(Mo),c(!1))}),()=>{p=!0})},[]),{addOns:i,copy:wv,isLoading:l}}function Sv(){const{items:i,incrementItem:a,decrementItem:l,removeItem:c}=Vn(),{addOns:p,copy:f}=Wo();return r.jsxs("div",{style:{flex:"0 0 65%",display:"flex",flexDirection:"column",gap:"32px"},children:[r.jsx("h2",{style:{margin:0,fontSize:"30px",lineHeight:"38px",fontWeight:"600",color:"var(--foreground)",fontFamily:"Inter, system-ui, sans-serif"},children:f.yourCartTitle}),r.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"12px"},children:i.map(m=>r.jsx(mp,{id:m.id,name:m.name,variant:m.variant,price:Bo(m.price),quantity:m.quantity,imageUrl:m.imageUrl,imageAlt:m.imageAlt,onIncrement:a,onDecrement:l,onRemove:c},m.id))}),r.jsx(He,{variant:"subtle",padding:"lg",children:r.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"20px"},children:[r.jsx("h4",{style:{margin:0,fontSize:"18px",lineHeight:"28px",fontWeight:"600",color:"var(--foreground)",fontFamily:"Inter, system-ui, sans-serif"},children:f.addOnsTitle}),r.jsx("div",{style:{display:"flex",gap:"16px"},children:p.map(m=>r.jsx(He,{variant:"subtle",padding:"md",children:r.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"12px",width:"200px"},children:[r.jsx("div",{style:{width:"100%",height:"160px",backgroundColor:"var(--muted)",borderRadius:"12px",overflow:"hidden"},children:m.imageUrl?r.jsx("img",{src:m.imageUrl,alt:m.imageAlt||m.name,style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}}):null}),r.jsx("div",{style:{fontSize:"14px",lineHeight:"20px",fontWeight:"600",color:"var(--foreground)",fontFamily:"Inter, system-ui, sans-serif"},children:m.name}),r.jsx("div",{style:{fontSize:"14px",lineHeight:"20px",fontWeight:"600",color:"var(--foreground)",fontFamily:"Inter, system-ui, sans-serif"},children:Bo(m.price)}),r.jsx(We,{variant:"ghost",size:"sm",label:f.addButtonLabel})]})},m.id))})]})})]})}function jv({title:i,subtitle:a,children:l,onClose:c,footer:p}){return r.jsx("div",{style:{position:"fixed",top:0,left:0,right:0,bottom:0,backgroundColor:"rgba(0, 0, 0, 0.4)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:50},onClick:c,children:r.jsxs("div",{style:{width:"520px",maxWidth:"92%",backgroundColor:"var(--card)",borderRadius:"20px",border:"1px solid var(--border)",boxShadow:"0 12px 24px -4px #1018280F, 0 6px 12px -4px #10182814",padding:"20px",display:"flex",flexDirection:"column",gap:"16px",position:"relative"},onClick:f=>f.stopPropagation(),children:[(i||a)&&r.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",position:"relative"},children:[r.jsxs("div",{children:[i&&r.jsx("div",{style:{fontSize:"18px",fontWeight:600,color:"var(--foreground)",lineHeight:"28px"},children:i}),a&&r.jsx("div",{style:{fontSize:"14px",color:"var(--muted-foreground)",lineHeight:"20px",marginTop:"4px"},children:a})]}),c&&r.jsx("div",{style:{position:"absolute",top:0,right:0},children:r.jsx("button",{onClick:c,style:{height:"36px",paddingLeft:"12px",paddingRight:"12px",borderRadius:"10px",backgroundColor:"transparent",color:"var(--foreground)",fontSize:"14px",lineHeight:"20px",fontWeight:"600",border:"none",display:"inline-flex",alignItems:"center",cursor:"pointer"},children:"Close"})})]}),r.jsx("div",{style:{flex:1,minHeight:"100px",display:"flex",flexDirection:"column",gap:"12px"},children:l}),p&&r.jsx("div",{style:{display:"flex",justifyContent:"flex-end",gap:"12px"},children:p})]})})}function bv({itemCount:i,subtotal:a,onContinue:l,onBack:c,onClose:p}){return r.jsxs(jv,{onClose:p,title:"Heading to checkout",subtitle:"You'll complete payment securely in checkout.",footer:r.jsx(Iv,{onContinue:l,onBack:c}),children:[r.jsx("div",{style:{height:"1px",backgroundColor:"var(--border)",marginTop:"-8px"}}),r.jsx(Cv,{itemCount:i,subtotal:a}),r.jsx(Ev,{})]})}function Cv({itemCount:i,subtotal:a}){return r.jsx(He,{variant:"subtle",padding:"md",children:r.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"10px"},children:[r.jsx(ll,{label:"Items",value:String(i),valueWeight:"600"}),r.jsx(ll,{label:"Shipping",value:"Calculated in checkout"}),r.jsx(ll,{label:"Total",value:Bo(a),valueWeight:"600",valueSize:"20px",valueLineHeight:"30px"}),r.jsx("div",{style:{marginTop:"6px"},children:r.jsx(it,{label:"No password needed",variant:"neutral",size:"sm"})})]})})}function ll({label:i,value:a,valueWeight:l="400",valueSize:c="14px",valueLineHeight:p="20px"}){return r.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[r.jsx("div",{style:{fontSize:"14px",lineHeight:"20px",color:"var(--muted-foreground)"},children:i}),r.jsx("div",{style:{fontSize:c,lineHeight:p,fontWeight:l,color:"var(--foreground)"},children:a})]})}function Ev(){return r.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"8px"},children:[r.jsx("div",{style:{position:"relative",height:"6px",width:"100%",backgroundColor:"var(--border)",borderRadius:"999px",overflow:"hidden"},children:r.jsx("div",{style:{position:"absolute",top:0,left:0,height:"6px",width:"45%",backgroundColor:"#4F46E5",borderRadius:"999px",transition:"width 0.3s ease-out"}})}),r.jsx("div",{style:{fontSize:"12px",lineHeight:"18px",color:"var(--muted-foreground)"},children:"Preparing your checkout…"})]})}function Iv({onContinue:i,onBack:a}){return r.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"12px",width:"100%"},children:[r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:"12px"},children:[r.jsx(We,{label:"Back to cart",variant:"ghost",size:"md",onClick:a}),r.jsx(We,{label:"Continue",variant:"primary",size:"md",onClick:i})]}),r.jsx("div",{style:{fontSize:"12px",lineHeight:"18px",color:"var(--muted-foreground)",textAlign:"right"},children:"If checkout doesn't open, try again."})]})}function hp({subtotal:i=5997,total:a=5997}){const{copy:l}=Wo();return r.jsx(He,{variant:"elevated",padding:"md",children:r.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[r.jsx("div",{style:{fontSize:"14px",lineHeight:"20px",fontWeight:"600",color:"var(--foreground)",fontFamily:"Inter, system-ui, sans-serif"},children:l.summaryTitle}),r.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"12px"},children:[r.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[r.jsx("div",{style:{fontSize:"14px",lineHeight:"20px",fontWeight:"400",color:"var(--muted-foreground)",fontFamily:"Inter, system-ui, sans-serif"},children:l.subtotalLabel}),r.jsx("div",{style:{fontSize:"14px",lineHeight:"20px",fontWeight:"600",color:"var(--foreground)",fontFamily:"Inter, system-ui, sans-serif"},children:Bo(i)})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[r.jsx("div",{style:{fontSize:"14px",lineHeight:"20px",fontWeight:"400",color:"var(--muted-foreground)",fontFamily:"Inter, system-ui, sans-serif"},children:l.shippingLabel}),r.jsx("div",{style:{fontSize:"14px",lineHeight:"20px",fontWeight:"400",color:"var(--muted-foreground)",fontFamily:"Inter, system-ui, sans-serif"},children:l.shippingValue})]}),r.jsx("div",{style:{height:"1px",backgroundColor:"var(--border)"}}),r.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[r.jsx("div",{style:{fontSize:"14px",lineHeight:"20px",fontWeight:"600",color:"var(--foreground)",fontFamily:"Inter, system-ui, sans-serif"},children:l.totalLabel}),r.jsx("h4",{style:{margin:0,fontSize:"18px",lineHeight:"28px",fontWeight:"600",color:"var(--foreground)",fontFamily:"Inter, system-ui, sans-serif"},children:Bo(a)})]})]}),r.jsx(pp,{}),r.jsx("div",{style:{fontSize:"12px",lineHeight:"18px",fontWeight:"400",color:"var(--muted-foreground)",fontFamily:"Inter, system-ui, sans-serif"},children:l.taxesLine})]})})}function Tv(){const{cartCount:i,subtotal:a,total:l,checkout:c}=Vn(),{copy:p}=Wo(),[f,m]=_.useState(!1);return r.jsxs("div",{style:{flex:"0 0 35%",display:"flex",flexDirection:"column",gap:"16px",position:"sticky",top:"24px"},children:[r.jsx(hp,{subtotal:a,total:l}),r.jsx(We,{variant:"primary",size:"lg",label:p.summaryCheckoutLabel,onClick:()=>m(!0)}),r.jsx(We,{variant:"secondary",size:"lg",label:p.summaryContinueLabel,onClick:()=>{window.location.href="/products"}}),r.jsx("div",{style:{fontSize:"12px",lineHeight:"18px",fontWeight:"400",color:"var(--muted-foreground)",fontFamily:"Inter, system-ui, sans-serif",textAlign:"center"},children:p.taxesLine}),f?r.jsx(bv,{itemCount:i,subtotal:a,onBack:()=>m(!1),onClose:()=>m(!1),onContinue:()=>{c()}}):null]})}function Fv(){return r.jsx(ot,{paddingTop:"80px",paddingBottom:"80px",background:"var(--muted)",children:r.jsx(he,{children:r.jsxs("div",{style:{display:"flex",gap:"24px",alignItems:"flex-start"},children:[r.jsx(Sv,{}),r.jsx(Tv,{})]})})})}function _v(){const{isLoading:i}=Wo();return i?r.jsx(hy,{}):r.jsx(Fv,{})}function Rv(){const{items:i,cartCount:a,subtotal:l,total:c,closeCartDrawer:p,incrementItem:f,decrementItem:m,removeItem:x}=Vn(),{copy:S}=Wo();return r.jsxs("div",{style:{position:"fixed",top:0,left:0,right:0,bottom:0,zIndex:50},children:[r.jsx("div",{onClick:p,style:{position:"absolute",inset:0,backgroundColor:"rgba(0, 0, 0, 0.5)"}}),r.jsxs("div",{style:{position:"absolute",right:0,top:0,bottom:0,width:"420px",backgroundColor:"var(--card)",borderLeft:"1px solid var(--border)",boxShadow:"-4px 0 6px -1px rgba(0, 0, 0, 0.1), -2px 0 4px -1px rgba(0, 0, 0, 0.06)",display:"flex",flexDirection:"column"},children:[r.jsx("div",{style:{padding:"24px",borderBottom:"1px solid var(--border)",flexShrink:0},children:r.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[r.jsx("h3",{style:{margin:0,fontSize:"18px",lineHeight:"28px",fontWeight:"600",color:"var(--foreground)",fontFamily:"Inter, system-ui, sans-serif"},children:S.title}),r.jsx(it,{label:`${a} ${S.writeItemSuffix}`,variant:"neutral",size:"sm"})]})}),r.jsxs("div",{style:{flex:1,overflowY:"auto",padding:"24px",display:"flex",flexDirection:"column",gap:"24px"},children:[i.length?r.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"12px"},children:i.map(j=>r.jsx(mp,{id:j.id,name:j.name,variant:j.variant,price:`₹${j.price.toLocaleString("en-IN")}`,quantity:j.quantity,imageUrl:j.imageUrl,imageAlt:j.imageAlt,onIncrement:f,onDecrement:m,onRemove:x},j.id))}):r.jsx("div",{style:{fontSize:"14px",lineHeight:"20px",fontWeight:"400",color:"var(--muted-foreground)",fontFamily:"Inter, system-ui, sans-serif"},children:S.emptyCartMessage}),r.jsx(hp,{subtotal:l,total:c})]}),r.jsxs("div",{style:{padding:"24px",borderTop:"1px solid var(--border)",flexShrink:0,display:"flex",flexDirection:"column",gap:"12px"},children:[r.jsx(We,{variant:"primary",size:"lg",label:S.drawerCheckoutLabel,onClick:()=>{p(),window.location.href="/cart"}}),r.jsx(We,{variant:"secondary",size:"lg",label:S.drawerContinueLabel,onClick:p}),r.jsx("div",{style:{fontSize:"12px",lineHeight:"18px",fontWeight:"400",color:"var(--muted-foreground)",fontFamily:"Inter, system-ui, sans-serif",textAlign:"center"},children:S.drawerFooterCaption})]})]})]})}function _d(){const i=window.location.pathname.replace(/\/+$/,"")||"/";if(i.startsWith("/products/"))return r.jsx(C0,{});if(/^\/account\/reset\/[^/]+\/[^/]+$/.test(i))return r.jsx(xd,{});switch(i){case"/":return r.jsx(gy,{});case"/products":return r.jsx(xv,{});case"/philosophy":return r.jsx(vy,{});case"/community":return r.jsx(Rx,{});case"/cart":return r.jsx(_v,{});case"/account":return r.jsx($g,{});case"/account/login":return r.jsx(_g,{});case"/account/register":return r.jsx(Rg,{});case"/account/password-reset":case"/account/forgot-password":return r.jsx(Ng,{});case"/account/password-reset/confirm":return r.jsx(xd,{});default:return r.jsx($x,{})}}function Nv(){const{isDrawerOpen:i}=Vn(),a=window.location.pathname.replace(/\/+$/,"")||"/";return a==="/account"||a.startsWith("/account/")?r.jsx(r.Fragment,{children:_d()}):r.jsxs(yx,{children:[_d(),i?r.jsx(Rv,{}):null]})}const zv=({...i})=>{const{theme:a="system"}=Cl();return r.jsx(nv,{theme:a,position:"top-center",className:"toaster group",style:{"--normal-bg":"var(--popover)","--normal-text":"var(--popover-foreground)","--normal-border":"var(--border)"},...i})};function Av({children:i}){return r.jsxs(Jg,{attribute:"class",defaultTheme:"system",enableSystem:!0,disableTransitionOnChange:!0,children:[r.jsx(Rh,{children:r.jsx(Yg,{children:i})}),r.jsx(zv,{})]})}const gp=document.getElementById("root");if(!gp)throw new Error('Root element with id "root" was not found.');ym.createRoot(gp).render(r.jsx(_.StrictMode,{children:r.jsx(Av,{children:r.jsx(Nv,{})})}));
